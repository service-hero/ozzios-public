...
`}function Lu(e,n){const t=String(e);let r=t.indexOf(n),i=r,a=0,o=0;if(typeof n!="string")throw new TypeError("Expected substring");for(;r!==-1;)r===i?++a>o&&(o=a):a=1,i=r+n.length,r=t.indexOf(n,i);return o}function Du(e,n){return!!(n.options.fences===!1&&e.value&&!e.lang&&/[^ \r\n]/.test(e.value)&&!/^[\t ]*(?:[\r\n]|$)|(?:^|[\r\n])[\t ]*$/.test(e.value))}function Mu(e){const n=e.options.fence||"`";if(n!=="`"&&n!=="~")throw new Error("Cannot serialize code with `"+n+"` for `options.fence`, expected `` ` `` or `~`");return n}function Fu(e,n,t,r){const i=Mu(t),a=e.value||"",o=i==="`"?"GraveAccent":"Tilde";if(Du(e,t)){const c=t.enter("codeIndented"),f=t.indentLines(a,Nu);return c(),f}const l=t.createTracker(r),s=i.repeat(Math.max(Lu(a,i)+1,3)),u=t.enter("codeFenced");let h=l.move(s);if(e.lang){const c=t.enter(`codeFencedLang${o}`);h+=l.move(t.safe(e.lang,{before:h,after:" ",encode:["`"],...l.current()})),c()}if(e.lang&&e.meta){const c=t.enter(`codeFencedMeta${o}`);h+=l.move(" "),h+=l.move(t.safe(e.meta,{before:h,after:`
...
*Building the future of home service business automation at [ozzios.com](https://ozzios.com). Follow the journey.*
    `},"gohighlevel-integration":{id:"gohighlevel-integration",title:"OzziOS Now Integrates with GoHighLevel: Supercharge Your CRM with AI",excerpt:"Connect your GoHighLevel account to OzziOS and let AI agents manage contacts, automate follow-ups, and sync data across your entire business operations—all without leaving the platform.",category:"product",categoryLabel:"Product Updates",author:{name:"Garrett Elmore",avatar:"/images/garrett-blog-profile-image.jpg",role:"Founder/CEO, OzziOS",bio:"Garrett is the founder and CEO of OzziOS, building AI-powered tools to help home service companies scale without the headcount.",twitter:"@garrettelmore"},image:"/images/ghl_ozzi_integrated_blog_post.jpg",readTime:"4 min read",date:"February 2, 2025",content:`
...
If you're not yet using OzziOS, [get early access](https://app.ozzios.com/sign-up) and see what's possible when your CRM gets AI superpowers.
...
*Have questions about the integration? [Check our documentation](https://docs.ozzios.com/integrations/gohighlevel) or reach out to support--we're here to help you get connected.*
    `},"future-of-home-service-work":{id:"future-of-home-service-work",title:"The Future of Home Service Businesses: Why AI Employees Are Inevitable",excerpt:"The traditional service business model is broken. Hiring costs $15-25K per employee, training takes months, and your best people leave—taking institutional knowledge with them. Here's how AI changes everything.",category:"ai",categoryLabel:"AI & Automation",author:{name:"Garrett Elmore",avatar:"/images/garrett-blog-profile-image.jpg",role:"Founder/CEO, OzziOS",bio:"Garrett is the founder and CEO of OzziOS, building AI-powered tools to help home service companies scale without the headcount.",twitter:"@garrettelmore"},image:"https://images.unsplash.com/photo-1677442136019-21780ecad995?w=1600&h=900&fit=crop&auto=format",readTime:"8 min read",date:"December 28, 2024",content:`
...
*Ready to meet your first AI employee? [Get early access](https://app.ozzios.com/sign-up) and see what's possible.*
    `},"replace-8-tools":{id:"replace-8-tools",title:"How We Replaced 8 Business Tools with One Platform",excerpt:"Mailchimp, Hootsuite, SEMrush, Asana—we cancelled them all. Here's how consolidation saved us $2,400/month.",category:"product",categoryLabel:"Product Updates",author:{name:"Garrett Elmore",avatar:"/images/garrett-blog-profile-image.jpg",role:"Founder/CEO, OzziOS",bio:"Garrett is the founder and CEO of OzziOS, building AI-powered tools to help home service companies scale without the headcount.",twitter:"@garrettelmore"},image:"https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1600&h=900&fit=crop&auto=format",readTime:"5 min read",date:"December 22, 2024",content:`
...
*Curious what tools you could replace? [Try our savings calculator](https://ozzios.com/#calculator) to see your potential savings.*
    `},"ai-seo-strategy":{id:"ai-seo-strategy",title:"AI-Powered SEO: A Complete Strategy Guide for 2025",excerpt:"Keyword research, technical audits, content optimization—all automated. Learn how AI agents handle SEO at scale.",category:"ai",categoryLabel:"AI & Automation",author:{name:"Garrett Elmore",avatar:"/images/garrett-blog-profile-image.jpg",role:"Founder/CEO, OzziOS",bio:"Garrett is the founder and CEO of OzziOS, building AI-powered tools to help home service companies scale without the headcount.",twitter:"@garrettelmore"},image:"https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1600&h=900&fit=crop&auto=format",readTime:"12 min read",date:"December 18, 2024",content:`
...
*Want to see AI SEO in action? [Watch our SEO Specialist agent](https://ozzios.com/#demo) analyze a site in real-time.*
    `},"scaling-without-hiring":{id:"scaling-without-hiring",title:"Scaling Your Service Business Without Adding Headcount",excerpt:"We grew from $50K to $200K MRR with the same team size. The secret? AI employees that work 24/7.",category:"growth",categoryLabel:"Business Growth",author:{name:"Garrett Elmore",avatar:"/images/garrett-blog-profile-image.jpg",role:"Founder/CEO, OzziOS",bio:"Garrett is the founder and CEO of OzziOS, building AI-powered tools to help home service companies scale without the headcount.",twitter:"@garrettelmore"},image:"https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1600&h=900&fit=crop&auto=format",readTime:"7 min read",date:"December 15, 2024",content:`
...
*Ready to scale differently? [See how other service businesses are doing it](https://ozzios.com/case-studies) or [get early access](https://app.ozzios.com/sign-up).*
    `},"content-automation":{id:"content-automation",title:"Content Creation at Scale: From 4 Posts to 40 Per Week",excerpt:"Our AI Content Writer generates blog posts, social content, and email campaigns—all in your brand voice.",category:"marketing",categoryLabel:"Marketing",author:{name:"Garrett Elmore",avatar:"/images/garrett-blog-profile-image.jpg",role:"Founder/CEO, OzziOS",bio:"Garrett is the founder and CEO of OzziOS, building AI-powered tools to help home service companies scale without the headcount.",twitter:"@garrettelmore"},image:"https://images.unsplash.com/photo-1552664730-d307ca884978?w=1600&h=900&fit=crop&auto=format",readTime:"6 min read",date:"December 10, 2024",content:`
...
*See the AI Content Writer in action. [Watch a demo](https://ozzios.com/#demo) or [start creating](https://app.ozzios.com/sign-up).*
    `},"customer-reporting-automation":{id:"customer-reporting-automation",title:"Automated Customer Reports That Actually Impress",excerpt:"Stop spending Sundays building reports. Our AI generates interactive dashboards customers can explore themselves.",category:"product",categoryLabel:"Product Updates",author:{name:"Garrett Elmore",avatar:"/images/garrett-blog-profile-image.jpg",role:"Founder/CEO, OzziOS",bio:"Garrett is the founder and CEO of OzziOS, building AI-powered tools to help home service companies scale without the headcount.",twitter:"@garrettelmore"},image:"https://images.unsplash.com/photo-1551434678-e076c223a692?w=1600&h=900&fit=crop&auto=format",readTime:"4 min read",date:"December 5, 2024",content:`
...
*Ready to reclaim your Sundays? [Get early access](https://app.ozzios.com/sign-up) and generate your first report in minutes.*
    `},"goodbye-overhead":{id:"goodbye-overhead",title:"Why We Stopped Outsourcing Our Marketing (And Never Looked Back)",excerpt:"$8K/month for work we couldn't see. Now we own the AI—full transparency, better results, fraction of the cost.",category:"growth",categoryLabel:"Business Growth",author:{name:"Garrett Elmore",avatar:"/images/garrett-blog-profile-image.jpg",role:"Founder/CEO, OzziOS",bio:"Garrett is the founder and CEO of OzziOS, building AI-powered tools to help home service companies scale without the headcount.",twitter:"@garrettelmore"},image:"https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=1600&h=900&fit=crop&auto=format",readTime:"9 min read",date:"November 28, 2024",content:`
