...
import { R as Rocket } from "./rocket-cR3SopE-.js";
...
const entries = [
  {
    ...
    tag: "new",
    description: "OzziOS is officially live. The full platform is now available to home service businesses of all sizes with AI-powered agents ready to handle marketing and business operations end-to-end.",
    items: [
  ...
  },
  {
    ...
    tag: "improvement",
    description: "Major expansion of the integration ecosystem. Agents can now connect to 30+ tools and services your business already uses.",
    items: [
  ...
  },
  {
    ...
    title: "Beta Release",
    tag: "new",
    description: "First beta release to select partners. Core agent system, conversation interface, and foundational integrations available for early testing.",
    items: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative pt-32 pb-16 lg:pt-40 lg:pb-20 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto max-w-[900px] px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "text-center mb-16", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "See what we've been building. Every update, improvement, and fix shipped to make OzziOS better for your business." })
        ] })
      }
    ) }) }),
