...
import { a4 as PenTool, A as ArrowRight, c as Clock, U as Users, a5 as TrendingDown, a3 as Layers, Z as Zap, p as Brain, j as Search, a6 as Share2, l as Mail, a7 as Video, I as ChartColumn, C as CircleCheck } from "./vendor-icons-D94uOSxG.js";
...
const painPoints = [
  {
    ...
    description: "A single blog post about your services takes 4-6 hours. A full content calendar takes weeks of planning. By the time you publish, your competitors already own the local search results."
  },
  {
    icon: Users,
    title: "Writers do not understand your trade",
    description: "Freelancers miss deadlines and do not know HVAC from plumbing. In-house writers cost $60K+/year. And neither can cover every service you offer. Quality swings wildly from piece to piece."
  },
  {
    icon: TrendingDown,
    title: "Content gets published and forgotten",
    description: "You spend hours creating a before/after project showcase, hit publish, share it once on social, and move on. No optimization, no repurposing, no distribution strategy. Most content dies the day it goes live."
  },
  {
    icon: Layers,
    title: "No system connects creation to results",
    description: "Your content calendar lives in one tool, local SEO data in another, social scheduling in a third. Nobody knows which content drives leads, and proving ROI is a guessing game."
  }
];
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Every service company knows content is king. But producing enough quality content consistently is a battle most lose." })
        ]
      }
    ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Service companies using OzziOS for content marketing produce more, rank higher locally, and book more jobs." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground tracking-tight mb-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-signature", children: "Start scaling it." })
        ] }),
...
function ContentMarketingView() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DeferredSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProblemSection, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DeferredSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(PipelineSection, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DeferredSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureHighlightsSection, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DeferredSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResultsSection, {}) }),
