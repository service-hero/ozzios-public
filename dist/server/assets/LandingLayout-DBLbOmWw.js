...
import { B as Button } from "./button-Dh_ejiKz.js";
import { c as createLucideIcon } from "./createLucideIcon-B3BVHTxy.js";
import { S as Sparkles, B as BookOpen, M as Menu } from "./sparkles-CB8QHL5C.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, c as usePresence, b as useIsomorphicLayoutEffect, L as LayoutGroupContext, A as ArrowRight, m as motion } from "./proxy-DsobtX3y.js";
const __iconNode$9 = [
      ...
      "header",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              className: cn(
                "absolute inset-x-0 bottom-0 h-[2px] bg-border transition-opacity duration-150",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:flex items-center gap-0", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: item.megaMenu ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  ...
                  {
                    to: item.href,
                    className: "px-4 py-2 text-[13px] font-semibold text-foreground/60 hover:text-foreground transition-colors",
                    children: item.label
                  }
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden lg:flex items-center gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  size: "sm",
                  asChild: true,
                  className: "h-9 px-5 text-[12px] font-bold uppercase tracking-wider bg-foreground text-background hover:bg-foreground/90 rounded-none",
            ...
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-auto mx-8 w-full max-w-[900px] pt-[22px]", children: navItems.map((item) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "border-2 border-border bg-card p-6 shadow-neo-lg",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-8", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn(
                        ...
                        section.title && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-bold text-foreground/40 uppercase tracking-[0.2em] mb-4", children: section.title }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: section.items.map((subItem) => {
                          ...
                          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            ...
                            {
                              href: subItem.href,
                              className: "flex items-start gap-3 p-3 transition-colors hover:bg-muted group",
                              children: [
                                Icon && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-9 w-9 border-2 border-border flex items-center justify-center shrink-0 group-hover:border-signature group-hover:bg-signature/10 transition-all duration-150", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-4 w-4 text-foreground/50 group-hover:text-signature transition-colors" }) }),
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] font-semibold text-foreground/80 group-hover:text-foreground transition-colors", children: subItem.label }),
                                    subItem.badge && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-1.5 py-0.5 text-[8px] font-bold uppercase tracking-wider text-white bg-signature", children: subItem.badge })
                                  ] }),
                                  subItem.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-foreground/40 mt-0.5", children: subItem.description })
                                ] })
                              ]
                            },
                            subItem.label
                      ...
                      item.megaMenu.cta && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-12 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "a",
                        {
                          ...
                          className: "block h-full border-2 border-border overflow-hidden transition-all hover:border-signature group",
                          children: [
                            item.megaMenu.cta.image && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-32 overflow-hidden", children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-foreground/60" })
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 bg-muted", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-signature flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-4 h-4 text-white" }) }) }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] font-bold text-foreground mb-1", children: item.megaMenu.cta.title }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-foreground/50 leading-relaxed mb-3", children: item.megaMenu.cta.description }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-[12px] font-bold text-signature", children: [
      ...
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full overflow-y-auto pt-[72px] pb-safe", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-8 space-y-2", children: [
          navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: item.megaMenu ? /* @__PURE__ */ jsxRuntimeExports.jsx(MobileMenuSection, { item, onClose: () => setIsMobileMenuOpen(false) }) : item.href?.startsWith("/") ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              to: item.href,
              className: "flex items-center h-12 text-[15px] font-semibold text-foreground/80",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-8 mt-6 border-t-2 border-border space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "https://app.ozzios.com/sign-in",
                className: "flex items-center justify-center h-12 text-[14px] font-semibold text-foreground/60 border-2 border-border hover:bg-muted transition-colors",
                onClick: () => setIsMobileMenuOpen(false),
                children: "Sign in"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                size: "lg",
                asChild: true,
                className: "w-full h-12 text-[12px] font-bold uppercase tracking-wider bg-foreground text-background hover:bg-foreground/90 rounded-none",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          item.label,
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: cn(
            "h-4 w-4 text-foreground/40 transition-transform duration-150",
            isOpen && "rotate-180"
          ) })
        ]
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-3 pl-4 space-y-6 border-l-2 border-border", children: item.megaMenu.sections.map((section, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          section.title && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-bold text-foreground/40 uppercase tracking-[0.2em] mb-3", children: section.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: section.items.map((subItem) => {
            const Icon = subItem.icon;
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: subItem.href,
                className: "flex items-center gap-3 py-2.5 text-foreground/60 hover:text-foreground transition-colors",
                onClick: onClose,
                children: [
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "relative border-t border-border bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[200px] pointer-events-none glow-amber-top" }),
