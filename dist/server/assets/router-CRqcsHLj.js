...
const $$splitComponentImporter$F = () => import("./waitlist-business-QczJ8Z30.js");
const Route$F = createFileRoute("/waitlist-business")({
...
const $$splitComponentImporter$E = () => import("./waitlist-B-pxofXL.js");
const Route$E = createFileRoute("/waitlist")({
...
const $$splitComponentImporter$D = () => import("./tos-BbE2tpJ4.js");
const Route$D = createFileRoute("/tos")({
...
const $$splitComponentImporter$C = () => import("./security-CVUFQ6i7.js");
const Route$C = createFileRoute("/security")({
  head: () => createPageHead({
    title: "Security",
...
const $$splitComponentImporter$B = () => import("./privacy-policy-C_Qdrb6I.js");
...
const $$splitComponentImporter$A = () => import("./pricing-jXauPVPM.js");
...
const $$splitComponentImporter$z = () => import("./integrations-B6KlFOBH.js");
const Route$z = createFileRoute("/integrations")({
  head: () => createPageHead({
    title: "Integrations",
...
const $$splitComponentImporter$y = () => import("./data-deletion-q-g0BHSl.js");
const Route$y = createFileRoute("/data-deletion")({
...
const $$splitComponentImporter$x = () => import("./contact-HpRyDCKW.js");
...
const $$splitComponentImporter$w = () => import("./changelog-CBpjzdJy.js");
const Route$w = createFileRoute("/changelog")({
  head: () => createPageHead({
    title: "Changelog",
...
const $$splitComponentImporter$v = () => import("./careers-DX2VMxir.js");
const Route$v = createFileRoute("/careers")({
  head: () => createPageHead({
    title: "Careers",
...
const $$splitComponentImporter$u = () => import("./blog-rsNg8IPm.js");
const Route$u = createFileRoute("/blog")({
  component: lazyRouteComponent($$splitComponentImporter$u, "component")
});
const $$splitComponentImporter$t = () => import("./about-DyY1OGgx.js");
...
const $$splitComponentImporter$s = () => import("./index-Dprzm04Y.js").then((n) => n.i);
...
const $$splitComponentImporter$r = () => import("./blog.index-CmCcVtaT.js");
...
const $$splitComponentImporter$q = () => import("./teams-BXInis0_.js");
const Route$q = createFileRoute("/solutions/teams")({
  head: () => createPageHead({
    title: "For Teams",
...
const $$splitComponentImporter$p = () => import("./solo-agencies-B7QxGLir.js");
const Route$p = createFileRoute("/solutions/solo-agencies")({
  head: () => createPageHead({
...
const $$splitComponentImporter$o = () => import("./lead-generation-CX49pqFY.js");
const Route$o = createFileRoute("/solutions/lead-generation")({
  head: () => createPageHead({
...
const $$splitComponentImporter$n = () => import("./enterprise-DpxjyBqU.js");
const Route$n = createFileRoute("/solutions/enterprise")({
  head: () => createPageHead({
    title: "Enterprise",
...
const $$splitComponentImporter$m = () => import("./content-marketing-BplxHTjZ.js");
const Route$m = createFileRoute("/solutions/content-marketing")({
  head: () => createPageHead({
...
const $$splitComponentImporter$l = () => import("./client-management-Dw6mzNRT.js");
const Route$l = createFileRoute("/solutions/client-management")({
  head: () => createPageHead({
...
const $$splitComponentImporter$k = () => import("./workflows-B_QaGonp.js");
const Route$k = createFileRoute("/features/workflows")({
  head: () => createPageHead({
    title: "Workflows",
...
const $$splitComponentImporter$j = () => import("./voice-agents-GKtIOADA.js");
const Route$j = createFileRoute("/features/voice-agents")({
  head: () => createPageHead({
    title: "Voice Agents",
...
const $$splitComponentImporter$i = () => import("./video-editor-BXf2W2gR.js");
const Route$i = createFileRoute("/features/video-editor")({
  head: () => createPageHead({
    title: "Video Editor",
...
const $$splitComponentImporter$h = () => import("./tasks-D0uwve_l.js");
const Route$h = createFileRoute("/features/tasks")({
  head: () => createPageHead({
...
const $$splitComponentImporter$g = () => import("./social-media-WpuzVaoI.js");
const Route$g = createFileRoute("/features/social-media")({
  head: () => createPageHead({
    title: "Social Media",
...
const $$splitComponentImporter$f = () => import("./sms-campaigns-6gZu4jQ6.js");
const Route$f = createFileRoute("/features/sms-campaigns")({
  head: () => createPageHead({
    title: "SMS Campaigns",
...
const $$splitComponentImporter$e = () => import("./presentations-Ur0tW0GC.js");
const Route$e = createFileRoute("/features/presentations")({
  head: () => createPageHead({
    title: "Presentations",
...
const $$splitComponentImporter$d = () => import("./knowledge-base-D68OB2c_.js");
const Route$d = createFileRoute("/features/knowledge-base")({
  head: () => createPageHead({
...
const $$splitComponentImporter$c = () => import("./forms-D6xGMqKJ.js");
const Route$c = createFileRoute("/features/forms")({
  head: () => createPageHead({
    title: "Forms",
...
const $$splitComponentImporter$b = () => import("./email-campaigns-CK8Gx6lb.js");
const Route$b = createFileRoute("/features/email-campaigns")({
  head: () => createPageHead({
...
const $$splitComponentImporter$a = () => import("./email-builder-gxfKz357.js");
const Route$a = createFileRoute("/features/email-builder")({
  head: () => createPageHead({
    title: "Email Builder",
...
const $$splitComponentImporter$9 = () => import("./documents-RL9wzk2a.js");
const Route$9 = createFileRoute("/features/documents")({
  head: () => createPageHead({
    title: "Documents",
...
const $$splitComponentImporter$8 = () => import("./dashboard-CW_Yv0DG.js");
const Route$8 = createFileRoute("/features/dashboard")({
  head: () => createPageHead({
    title: "Dashboard",
...
const $$splitComponentImporter$7 = () => import("./crm-BCX3YmnW.js");
const Route$7 = createFileRoute("/features/crm")({
  head: () => createPageHead({
    title: "CRM",
...
const $$splitComponentImporter$6 = () => import("./coding-CvKn6elE.js");
const Route$6 = createFileRoute("/features/coding")({
  head: () => createPageHead({
    title: "Code Sandbox",
...
const $$splitComponentImporter$5 = () => import("./chat-widget-oaJa3eZ0.js");
const Route$5 = createFileRoute("/features/chat-widget")({
  head: () => createPageHead({
    title: "Chat Widget",
...
const $$splitComponentImporter$4 = () => import("./channels-R4DJaiYn.js");
...
const $$splitComponentImporter$3 = () => import("./blog-seo-bUdhfdQY.js");
...
const $$splitComponentImporter$2 = () => import("./ai-agents-B6t5vBDe.js");
...
const $$splitComponentImporter$1 = () => import("./_-BaQBdtZ9.js");
const docsContent = {
  "installation": {
    title: "Setting Up",
...
const $$splitComponentImporter = () => import("./blog._postId-BxbLT_rt.js");
...
const WaitlistBusinessRoute = Route$F.update({
  id: "/waitlist-business",
  path: "/waitlist-business",
  getParentRoute: () => Route$G
});
const WaitlistRoute = Route$E.update({
  id: "/waitlist",
  path: "/waitlist",
  getParentRoute: () => Route$G
});
const TosRoute = Route$D.update({
  id: "/tos",
  path: "/tos",
  getParentRoute: () => Route$G
});
const SecurityRoute = Route$C.update({
  id: "/security",
  path: "/security",
  getParentRoute: () => Route$G
});
...
const IntegrationsRoute = Route$z.update({
  id: "/integrations",
  path: "/integrations",
  getParentRoute: () => Route$G
});
const DataDeletionRoute = Route$y.update({
  id: "/data-deletion",
  path: "/data-deletion",
  getParentRoute: () => Route$G
});
...
const ChangelogRoute = Route$w.update({
  id: "/changelog",
  path: "/changelog",
  getParentRoute: () => Route$G
});
const CareersRoute = Route$v.update({
  id: "/careers",
  path: "/careers",
  getParentRoute: () => Route$G
});
...
const BlogIndexRoute = Route$r.update({
  id: "/",
  path: "/",
  getParentRoute: () => BlogRoute
});
const SolutionsTeamsRoute = Route$q.update({
  id: "/solutions/teams",
  path: "/solutions/teams",
  getParentRoute: () => Route$G
});
const SolutionsSoloAgenciesRoute = Route$p.update({
  id: "/solutions/solo-agencies",
  path: "/solutions/solo-agencies",
  getParentRoute: () => Route$G
});
const SolutionsLeadGenerationRoute = Route$o.update({
  id: "/solutions/lead-generation",
  path: "/solutions/lead-generation",
  getParentRoute: () => Route$G
});
const SolutionsEnterpriseRoute = Route$n.update({
  id: "/solutions/enterprise",
  path: "/solutions/enterprise",
  getParentRoute: () => Route$G
});
const SolutionsContentMarketingRoute = Route$m.update({
  id: "/solutions/content-marketing",
  path: "/solutions/content-marketing",
  getParentRoute: () => Route$G
});
const SolutionsClientManagementRoute = Route$l.update({
  id: "/solutions/client-management",
  path: "/solutions/client-management",
  getParentRoute: () => Route$G
});
const FeaturesWorkflowsRoute = Route$k.update({
  id: "/features/workflows",
  path: "/features/workflows",
  getParentRoute: () => Route$G
});
const FeaturesVoiceAgentsRoute = Route$j.update({
  id: "/features/voice-agents",
  path: "/features/voice-agents",
  getParentRoute: () => Route$G
});
const FeaturesVideoEditorRoute = Route$i.update({
  id: "/features/video-editor",
  path: "/features/video-editor",
  getParentRoute: () => Route$G
});
const FeaturesTasksRoute = Route$h.update({
  id: "/features/tasks",
  path: "/features/tasks",
  getParentRoute: () => Route$G
});
const FeaturesSocialMediaRoute = Route$g.update({
  id: "/features/social-media",
  path: "/features/social-media",
  getParentRoute: () => Route$G
});
const FeaturesSmsCampaignsRoute = Route$f.update({
  id: "/features/sms-campaigns",
  path: "/features/sms-campaigns",
  getParentRoute: () => Route$G
});
const FeaturesPresentationsRoute = Route$e.update({
  id: "/features/presentations",
  path: "/features/presentations",
  getParentRoute: () => Route$G
});
const FeaturesKnowledgeBaseRoute = Route$d.update({
  id: "/features/knowledge-base",
  path: "/features/knowledge-base",
  getParentRoute: () => Route$G
});
const FeaturesFormsRoute = Route$c.update({
  id: "/features/forms",
  path: "/features/forms",
  getParentRoute: () => Route$G
});
const FeaturesEmailCampaignsRoute = Route$b.update({
  id: "/features/email-campaigns",
  path: "/features/email-campaigns",
  getParentRoute: () => Route$G
});
const FeaturesEmailBuilderRoute = Route$a.update({
  id: "/features/email-builder",
  path: "/features/email-builder",
  getParentRoute: () => Route$G
});
const FeaturesDocumentsRoute = Route$9.update({
  id: "/features/documents",
  path: "/features/documents",
  getParentRoute: () => Route$G
});
const FeaturesDashboardRoute = Route$8.update({
  id: "/features/dashboard",
  path: "/features/dashboard",
  getParentRoute: () => Route$G
});
const FeaturesCrmRoute = Route$7.update({
  id: "/features/crm",
  path: "/features/crm",
  getParentRoute: () => Route$G
});
const FeaturesCodingRoute = Route$6.update({
  id: "/features/coding",
  path: "/features/coding",
  getParentRoute: () => Route$G
});
const FeaturesChatWidgetRoute = Route$5.update({
