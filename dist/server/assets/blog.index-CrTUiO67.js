import { a as reactExports, n as jsxRuntimeExports } from "./worker-entry-Mj0z-o-D.js";
...
function BlogView() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "text-center mb-16", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-semibold text-amber-400/80 uppercase tracking-[0.2em] mb-4", children: "Blog" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-[clamp(2.5rem,6vw,4rem)] font-display leading-[1.05] tracking-[-0.02em] text-foreground mb-6", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-gradient-to-r from-amber-200 via-orange-300 to-amber-200 bg-clip-text text-transparent", children: "AI-first agency" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-foreground/40 max-w-xl mx-auto", children: "Strategies, case studies, and product updates to help you build an agency that scales without the headcount." })
            ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 overflow-x-auto pb-2 sm:pb-0 w-full sm:w-auto", children: categories.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: cn(
                    ...
                    activeCategory === category.id ? "bg-amber-500/20 text-amber-400 border border-amber-500/30" : "text-foreground/50 hover:text-foreground/70 hover:bg-white/[0.05] border border-transparent"
                  ),
              ...
              Link,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-64 lg:h-auto lg:min-h-[400px] overflow-hidden", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-4 left-4 flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-amber-500/20 border border-amber-500/30 backdrop-blur-sm", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-3.5 h-3.5 text-amber-400" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold text-amber-400 uppercase tracking-wider", children: "Trending" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative p-8 lg:p-12 flex flex-col justify-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2.5 py-1 rounded-md bg-indigo-500/20 text-[11px] font-semibold text-indigo-400 uppercase tracking-wider", children: categories.find((c) => c.id === featuredPost.category)?.label }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px] text-foreground/30", children: featuredPost.date })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl lg:text-3xl font-display text-foreground mb-4 group-hover:text-amber-200 transition-colors", children: featuredPost.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] text-foreground/50 leading-relaxed mb-6", children: featuredPost.excerpt }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-auto", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-foreground/40", children: featuredPost.author.role })
                        ] })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-[13px] text-foreground/40", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-4 h-4" }),
                        featuredPost.readTime
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 right-8 lg:bottom-12 lg:right-12 flex items-center gap-2 text-[13px] font-medium text-amber-400 opacity-0 group-hover:opacity-100 transition-opacity", children: [
                      "Read article",
                  ...
                  Link,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-48 overflow-hidden", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 left-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-1 rounded-md bg-black/50 backdrop-blur-sm text-[10px] font-semibold text-foreground/70 uppercase tracking-wider", children: categories.find((c) => c.id === post.category)?.label }) })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-6 flex flex-col", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3 text-[11px] text-foreground/40", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: post.date }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1 h-1 rounded-full bg-foreground/20" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-3 h-3" }),
                            post.readTime
                          ] })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[17px] font-semibold text-foreground mb-3 group-hover:text-amber-200 transition-colors line-clamp-2", children: post.title }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-foreground/40 leading-relaxed mb-4 line-clamp-2 flex-1", children: post.excerpt }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-auto pt-4 border-t border-white/[0.06]", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "img",
                            {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px] text-foreground/50", children: post.author.name }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-3.5 h-3.5 text-foreground/30 ml-auto opacity-0 group-hover:opacity-100 transition-all group-hover:translate-x-1" })
                        ] })
                      ] })
                    ]
                  }
            ...
            filteredPosts.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/40 text-lg mb-2", children: "No articles found" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/30 text-[14px]", children: "Try adjusting your search or filter" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "mt-16 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "inline-flex items-center gap-2 px-6 py-3 rounded-full border border-white/[0.1] bg-white/[0.02] text-[14px] font-medium text-foreground/60 hover:text-foreground hover:bg-white/[0.05] hover:border-white/[0.15] transition-all", children: [
              "Load more articles",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-24 border-t border-white/[0.06]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-[600px] px-6 lg:px-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] text-foreground/40 mb-8", children: "Weekly strategies for building an AI-first agency. No spam, unsubscribe anytime." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "h-12 px-6 rounded-xl bg-white text-[#0A0A0B] font-medium text-[14px] hover:bg-white/90 transition-colors whitespace-nowrap", children: "Subscribe" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-[12px] text-foreground/30", children: "Join 2,000+ agency owners already subscribed" })
        ]
      }
    ) }) })
  ] });
