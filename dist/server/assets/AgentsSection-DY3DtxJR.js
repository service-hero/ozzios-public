...
import { f as Search, W as Share2, M as Mail, Y as Video, t as FileText, G as Globe, b9 as Wrench, aN as Palette, Z as Zap } from "./vendor-icons-RMyvaHp0.js";
...
function AgentsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "agents", className: "py-32 lg:py-40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1440px] px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "max-w-5xl text-[clamp(3rem,5.4vw,5.4rem)] font-display font-medium leading-[0.92] tracking-[-0.06em] text-foreground mb-6", children: [
            content.headline[0],
        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row min-h-[320px]", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-8 lg:p-12 flex flex-col justify-center", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-3xl lg:text-4xl font-display font-medium text-foreground mb-4", children: "Meet Ozzi — your AI operations supervisor." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground leading-relaxed mb-8 font-light max-w-lg", children: "Think of Ozzi as the foreman for your AI agent team. He coordinates every agent — assigning tasks, reviewing outputs, catching errors, and making sure the work gets done. The same autonomous agent technology powering platforms like Manus, purpose-built for your trade." }),
