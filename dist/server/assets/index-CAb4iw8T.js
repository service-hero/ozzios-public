...
import { u as useAudience, a as audienceContent, L as LandingLayout } from "./LandingLayout-D-c6g3QV.js";
import { L as Link } from "./vendor-router-DD_41qJ4.js";
import { c as cn } from "./utils-QXBWQHlM.js";
import { A as ArrowRight, o as Play, X, p as ArrowUpRight, q as Command, e as ChevronDown, r as Star, s as Hash, t as Menu, f as Search, u as Settings, h as MessageSquare, C as CircleCheck, v as FileText, w as StickyNote, j as Sparkles, x as ChartColumn, D as DollarSign, W as Wrench, y as Smartphone, z as Phone, I as RefreshCw, J as ClipboardList, g as Send } from "./vendor-icons-BFmuwI-v.js";
...
function DemoFrame(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-xl border border-border/70 bg-background shadow-[0_30px_80px_-30px_rgba(34,27,22,0.35),0_2px_0_rgba(255,255,255,0.6)_inset] ring-1 ring-foreground/5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-9 items-center gap-3 border-b border-border/60 bg-muted/30 px-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-6 w-full max-w-[420px] items-center gap-2 rounded-md border border-border/60 bg-background px-2 text-[11px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative flex h-1.5 w-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "truncate font-mono text-foreground/55", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex aspect-[3/4] overflow-hidden bg-background sm:aspect-[4/3] md:aspect-[16/9]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          DemoSidebar,
          {
            activeChannel,
...
function DemoChannelHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-between border-b border-border/60 bg-background px-3 py-2 sm:px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "h-4 w-4 text-muted-foreground" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Hash, { className: "h-3.5 w-3.5 text-muted-foreground" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "max-w-[120px] truncate text-[12px] font-semibold text-foreground", children: activeChannel }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ChevronDown,
            {
              className: cn(
...
function DemoTabs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5 border-b border-border/60 bg-background px-3 py-1.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto inline-flex items-center gap-1 text-[10px] text-foreground/40", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Kbd, { className: "h-[16px] min-w-[16px] text-[9px]", children: "⌘" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Kbd, { className: "h-[16px] min-w-[16px] text-[9px]", children: "/" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "switch view" })
    ] })
  ] });
}
function DemoComposer({ activeChannel }) {
  const suggestions = channelSuggestions[activeChannel] ?? channelSuggestions["lead-follow-up"];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/60 bg-background px-3 pb-2.5 pt-2.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "scrollbar-hidden mb-2 flex items-center gap-1.5 overflow-x-auto", children: [
      ...
      suggestions.map((chip) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(chip.icon, { className: "h-3 w-3 text-foreground/45 transition-colors group-hover/chip:text-signature" }),
    ...
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1 overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-1 flex flex-wrap items-center gap-1 sm:gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "max-w-[120px] truncate text-[11px] font-semibold text-foreground sm:max-w-none sm:text-[12px]", children: message.user }),
...
const BentoSection = reactExports.lazy(
  () => import("./BentoSection-D-u1A2jI.js").then((m) => ({ default: m.BentoSection }))
);
const FeaturesShowcaseSection = reactExports.lazy(
  () => import("./FeaturesShowcaseSection-Skq53_e8.js").then((m) => ({
    default: m.FeaturesShowcaseSection
  }))
);
const SavingsCalculatorSection = reactExports.lazy(
  () => import("./SavingsCalculatorSection-Dt1KExxW.js").then((m) => ({
    default: m.SavingsCalculatorSection
  }))
);
const FeaturesSection = reactExports.lazy(
  () => import("./HowItWorksSection-Mm0izFxm.js").then((m) => ({ default: m.FeaturesSection }))
);
const AgentsSection = reactExports.lazy(
  () => import("./AgentsSection-e8oRGngf.js").then((m) => ({ default: m.AgentsSection }))
);
const MemorySection = reactExports.lazy(
  () => import("./MemorySection-BUj2fcAx.js").then((m) => ({ default: m.MemorySection }))
);
const PricingSection = reactExports.lazy(
  () => import("./PricingSection-OH4qRBLq.js").then((m) => ({ default: m.PricingSection }))
);
const IntegrationsSection = reactExports.lazy(
  () => import("./IntegrationsSection-zC-NkMVE.js").then((m) => ({
    default: m.IntegrationsSection
  }))
);
const TestimonialsSection = reactExports.lazy(
  () => import("./TestimonialsSection-D0nwGEIe.js").then((m) => ({
    default: m.TestimonialsSection
  }))
);
const FAQSection = reactExports.lazy(
  () => import("./FAQSection-CzS-nUQF.js").then((m) => ({ default: m.FAQSection }))
);
const CTASection = reactExports.lazy(
  () => import("./CTASection-BifHbL0c.js").then((m) => ({ default: m.CTASection }))
);
