import { a as reactExports, n as jsxRuntimeExports, q as requireShim, s as commonjsGlobal } from "./worker-entry-D9YBKU4i.js";
import { u as useAudience, b as audienceContent, A as AnimatePresence, C as ChevronDown, a as MessageSquare, F as FileText, c as Bot, U as Users, W as Workflow, d as Code, S as Share2, M as Mail, e as Monitor, f as SquareCheckBig, g as LayoutDashboard, P as Phone, h as MessageSquareText, i as Palette, B as Brain, L as LandingLayout } from "./LandingLayout-Cw0B8ZQ9.js";
import { c as createSlot, B as Button } from "./button-9hTLAGkd.js";
import { L as Link } from "./router-CpnZ0YBq.js";
import { c as cn } from "./utils-QXBWQHlM.js";
import { a as animateVisualElement, s as setTarget, u as useConstant, b as useIsomorphicLayoutEffect$1, m as motion, A as ArrowRight } from "./proxy-DirR3PYt.js";
import { B as Briefcase } from "./briefcase-Dg9XFh_H.js";
import { B as Building2 } from "./building-2-CjvW2NEv.js";
import { S as Shield } from "./shield-D0orxM8Y.js";
import { Z as Zap } from "./zap-eovvKv4x.js";
import { P as Play } from "./play-Um-29JtF.js";
import { S as Star, a as Settings } from "./star-CHC9wS0J.js";
import { H as Hash } from "./hash-Dr-k61Ll.js";
import { M as Menu, B as BookOpen } from "./menu-A3VZj51l.js";
import { S as Search } from "./search-DLH-8YYP.js";
import { C as CircleCheck } from "./circle-check-D2uhpNSv.js";
import { c as createLucideIcon } from "./createLucideIcon-vrAkbvDe.js";
import { S as Sparkles } from "./sparkles-DodYIojq.js";
import { S as Send } from "./send-DRDz5JSz.js";
import { L as Layers } from "./layers-Bt41T97b.js";
import { M as Megaphone } from "./megaphone-DppFUquP.js";
import { C as ChartColumn } from "./chart-column-DlsQwLMF.js";
import { W as Wrench } from "./wrench-0NhFXuYs.js";
import { S as Server } from "./server-Ci4WG5CT.js";
import { C as Clock } from "./clock-gZdHLzWg.js";
import { F as FileCheck } from "./file-check-kQ7v1vWf.js";
import { M as MessageCircle } from "./message-circle-DbNCy-Ev.js";
import { u as useInView } from "./use-in-view-VC2yu7L2.js";
import { C as Check } from "./check-B4hjQ47d.js";
import { R as Rocket } from "./rocket-dBR-0LOy.js";
import { T as TrendingUp } from "./trending-up-9_T9_KhM.js";
import { P as PenTool } from "./pen-tool-DOfHevKe.js";
import { H as History } from "./history-DFiDsvXX.js";
import { C as CTASection } from "./CTASection-CljaBu76.js";
import "node:events";
...
const Calculator = createLucideIcon("calculator", __iconNode$8);
const __iconNode$7 = [
...
const FileInput = createLucideIcon("file-input", __iconNode$5);
const __iconNode$4 = [
  [
    "path",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 w-full mx-auto max-w-[1400px] px-6 lg:px-8 pt-32 pb-20 lg:pt-40 lg:pb-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$7, className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-1 p-1 rounded-full bg-muted border border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    onClick: () => setAudience("business"),
                    className: `flex items-center gap-2 px-4 py-2 rounded-full text-[12px] font-medium transition-all duration-300 ${isBusinessOwner ? "bg-background text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
                    children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    className: `flex items-center gap-2 px-4 py-2 rounded-full text-[12px] font-medium transition-all duration-300 ${isAgency ? "bg-background text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
                    children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$7, className: "mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-3 px-4 py-2 rounded-full bg-muted/50 border border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-3.5 h-3.5 text-muted-foreground" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-medium text-muted-foreground uppercase tracking-wider", children: "SOC 2 Compliant" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-3 bg-border" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-3.5 h-3.5 text-signature" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-medium text-muted-foreground uppercase tracking-wider", children: "Enterprise Ready" })
                ] })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$7, className: "text-center max-w-5xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.h1,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative inline-block", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 text-signature", children: content.headline[1] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "svg",
                        {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex items-center justify-center w-8 h-8 rounded-full bg-muted group-hover:bg-border transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "h-3 w-3 fill-current ml-0.5" }) }),
                          "Watch demo"
                        ]
                      }
                    )
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-2xl border border-border bg-background overflow-hidden shadow-2xl shadow-black/10", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-[11px] font-medium text-muted-foreground uppercase tracking-[0.2em] mb-8", children: [
                      "Trusted by leading ",
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-6xl px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants$6, className: "mb-16 max-w-2xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-muted-foreground uppercase tracking-widest mb-3", children: content.sectionLabel }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight tracking-tight text-foreground mb-4", children: [
                content.headline[0],
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: content.headline[1] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground leading-relaxed", children: content.subheadline })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$6, className: "col-span-12 lg:col-span-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BentoCard, { featured: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row h-full min-h-[320px]", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-8 lg:p-10 flex flex-col", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl lg:text-3xl font-semibold text-foreground mb-3", children: content.cards.aiWorkforce.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground leading-relaxed mb-8", children: content.cards.aiWorkforce.description }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$6, className: "col-span-12 sm:col-span-6 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BentoCard, { className: "h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-7 flex flex-col h-full", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$6, className: "col-span-12 lg:col-span-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BentoCard, { className: "h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row h-full min-h-[280px]", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$6, className: "col-span-12 sm:col-span-6 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BentoCard, { className: "h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-7 flex flex-col h-full", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto flex flex-wrap gap-2", children: ["Meta", "Google", "LinkedIn", "TikTok"].map((platform) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: "px-2.5 py-1 text-xs font-medium text-muted-foreground bg-muted rounded-md",
                    children: platform
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$6, className: "col-span-12 sm:col-span-6 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BentoCard, { className: "h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-7 flex flex-col h-full", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-signature", children: "SOC 2 Ready" })
                ] })
              ] }) }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$6, className: "mt-8 p-6 rounded-2xl bg-muted/50 border border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: cn(
        ...
        featured ? "border-2 border-border shadow-sm hover:shadow-md" : "border border-border hover:shadow-sm",
        className
      ),
      children
    }
...
function ComparisonSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "comparison", className: "py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants$5, className: "text-center mb-16 lg:mb-20 max-w-2xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-signature uppercase tracking-wide mb-3", children: "How We're Different" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl lg:text-5xl font-display tracking-tight text-foreground mb-6", children: [
            "Open-source agent",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "vs. your AI team" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground leading-relaxed", children: "OpenClaw is a powerful open-source tool for developers. OzziOS is a complete AI marketing team for businesses. Different tools, different jobs." })
        ] }),
          ...
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 w-10 rounded-xl bg-card border border-border flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cloud, { className: "h-5 w-5 text-signature" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-foreground mb-1", children: "Both are great. Pick the right one." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-xl", children: "If you're a developer who wants full control and loves tinkering — OpenClaw is fantastic. If you want a marketing team that works out of the box without managing infrastructure — that's OzziOS." })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
...
function FeaturesShowcaseSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "showcase", className: "py-24 lg:py-32 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: "hidden",
      whileInView: "visible",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants$4, className: "mb-12 lg:mb-16 max-w-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-signature uppercase tracking-[0.15em] mb-3", children: "Features" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight tracking-tight text-foreground mb-4", children: [
            "Everything your team needs.",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "One platform." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground leading-relaxed", children: "17 features that replace your entire marketing stack. Explore each one." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$4, className: "mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 overflow-x-auto pb-2 -mx-1 px-1 scrollbar-hide", children: categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$4, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserChrome, { url: `app.ozzios.com/${activeFeature.id}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$4, className: "mt-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
...
function BrowserChrome({ children, url }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-background overflow-hidden shadow-2xl shadow-black/10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-3 border-b border-border bg-muted/50", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 mx-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted rounded-md px-3 py-1.5 text-xs text-muted-foreground font-mono", children: url }) })
    ] }),
    children
  ] });
}
...
function SocialMediaPreview() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      ...
      ].map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("w-5 h-5 rounded-full flex items-center justify-center", p.color), children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] font-bold text-white", children: p.name[0] }) }, p.name)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground font-mono w-14", children: post.time }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-foreground/60 w-14", children: post.platform }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-foreground flex-1 truncate", children: post.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: cn(
...
function TasksPreview() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    ...
    ].map((col, colIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/50 rounded-lg p-2.5", children: [
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants$3, className: "text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-signature/10 border border-signature/20 mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator, { className: "h-4 w-4 text-signature" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold text-signature uppercase tracking-wider", children: "ROI Calculator" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl lg:text-5xl font-display tracking-tight text-foreground mb-4", children: "See what you'll save." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Calculate your potential savings across agencies, employees, and tools." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$3, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-border bg-card overflow-hidden shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-8 p-6 lg:p-10", children: [
                  ...
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 rounded-xl bg-muted/50 border border-border", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-muted-foreground mb-3", children: "What you're paying for:" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 rounded-xl bg-signature/5 border border-signature/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-muted-foreground", children: "Run a 20-person agency with 7 people. AI handles the repetitive work—your team focuses on strategy and relationships." })
                        ] })
                      ] }) })
                    ]
                  },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 rounded-2xl bg-muted/50 border border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
                  ...
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-3 border-t border-border", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] text-muted-foreground", children: "Current annual spend" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-[12px] text-muted-foreground mt-3", children: "7-day free trial • Cancel anytime" })
              ] })
            ] }) }) }) })
          ] })
        ] }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$3, className: "mt-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-muted-foreground", children: "* Calculations are estimates based on industry averages. Your actual savings may vary." }) })
      ]
    }
  ) }) });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "how-it-works", className: "py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1200px] px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-signature uppercase tracking-wide mb-3", children: content.sectionLabel }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl lg:text-5xl font-display tracking-tight text-foreground mb-6", children: [
            content.headline[0],
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: content.headline[1] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "space-y-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold text-muted-foreground uppercase tracking-wider", children: "Channel Agents" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground", children: "10 agents" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  className: cn(
                    ...
                    isActive ? "border-signature/30 bg-signature/[0.02] shadow-sm" : "border-border bg-card hover:border-border hover:shadow-sm"
                  ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold text-muted-foreground uppercase tracking-wider", children: "Executive Agents" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground", children: "4 agents" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: executiveAgents.map((agent) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 inline-block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      SiriOrbAvatar,
                      {
                        size: 56,
                        variant: agent.variant,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[14px] font-semibold text-foreground mb-1", children: agent.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: cn(
                      "text-[11px] mb-2 transition-colors",
                      isActive ? "text-signature" : "text-muted-foreground"
                    ), children: agent.scope }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-muted-foreground", children: agent.description })
                  ]
                },
                agent.name
              );
...
function MemorySection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "memory", className: "py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "mb-16 lg:mb-20 max-w-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-signature uppercase tracking-wide mb-3", children: content.sectionLabel }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl lg:text-5xl font-display tracking-tight text-foreground mb-6", children: [
            content.headline[0],
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-8 lg:gap-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/50 rounded-2xl p-8 lg:p-10", children: [
...
function PricingSection() {
  const ref = reactExports.useRef(null);
  const isInView = useInView(ref, { once: true, margin: "-100px" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "pricing", className: "relative py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ref,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-muted-foreground uppercase tracking-widest mb-3", children: "Pricing" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl font-semibold text-foreground tracking-tight mb-4", children: "Simple, transparent pricing" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Stop overpaying for agencies. Get enterprise-level marketing automation at a fraction of the cost." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start", children: pricingTiers.map((tier, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        animate: isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 },
        ...
        className: cn(
          ...
          tier.recommended ? "border-2 border-signature bg-card lg:col-span-2" : "border border-border bg-card hover:border-border"
        ),
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn(tier.recommended && "lg:flex lg:gap-10"), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn(tier.recommended && "lg:flex-1 lg:min-w-0"), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold text-foreground mb-1", children: tier.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: tier.tagline })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-5xl font-semibold text-foreground tracking-tight", children: tier.price === 0 ? "Free" : `$${tier.price.toLocaleString()}` }),
                tier.price > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base text-muted-foreground", children: "/month" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-3", children: tier.description })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                className: cn(
                  ...
                  tier.recommended ? "bg-signature text-white hover:bg-signature/90 mb-6 lg:mb-0" : "bg-card text-foreground border border-border hover:bg-muted/50 mb-8"
                ),
                children: [
                  tier.cta,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn(tier.recommended && "lg:flex-1 lg:min-w-0"), children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: tier.features.map((feature, featureIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
            !feature.includes("Everything in") && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-5 h-5 text-muted-foreground shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn(
              "text-sm",
              feature.includes("Everything in") ? "text-muted-foreground font-medium" : "text-muted-foreground"
            ), children: feature })
          ] }, featureIndex)) }) })
        ] })
      },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        className: "mt-16 text-center",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "All plans include a 7-day free trial. Cancel anytime." }),
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-signature uppercase tracking-[0.15em] mb-4", children: content.sectionLabel }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl lg:text-5xl font-semibold text-foreground leading-tight tracking-tight mb-4", children: [
                content.headline[0],
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: content.headline[1] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground max-w-md mx-auto", children: content.subheadline })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground max-w-md mx-auto", children: "Everything you need to know about OzziOS." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { initial: false, children: isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pl-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] leading-relaxed text-muted-foreground", children: answer })
            ] }) })
          }
        ) })
      ]
...
function LandingHomeView() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FeaturesShowcaseSection, {}),
