...
import { U as Users, C as ChevronDown, A as AnimatePresence, X, L as LandingLayout } from "./LandingLayout-Cw0B8ZQ9.js";
...
function PricingCards() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-24 lg:py-32 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-6 lg:px-8", ref, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start", children: pricingTiers.map((tier, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        animate: isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 },
        ...
        className: cn(
          ...
          tier.recommended ? "border-2 border-signature bg-white lg:col-span-2" : "border border-gray-200 bg-white hover:border-gray-300"
        ),
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn(tier.recommended && "lg:flex lg:gap-10"), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn(tier.recommended && "lg:flex-1 lg:min-w-0"), children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-5xl font-semibold text-black tracking-tight", children: tier.price === 0 ? "Free" : `$${tier.price.toLocaleString()}` }),
                  tier.price > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base text-gray-400", children: "/month" })
                ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  className: cn(
                    ...
                    tier.recommended ? "bg-signature text-white hover:bg-signature/90 mb-6 lg:mb-0" : "bg-white text-black border border-gray-300 hover:bg-gray-50 mb-8"
                  ),
                  children: [
                    tier.cta,
