...
import { V as Target, A as ArrowRight, c as Clock, T as TriangleAlert, Y as Shuffle, _ as TrendingUp, Z as Zap, n as Brain, M as Mail, f as Search, U as Users, x as ChartColumn, C as CircleCheck } from "./vendor-icons-BFmuwI-v.js";
...
const painPoints = [
  {
    ...
    description: "A homeowner fills out your form at 11pm. By the time you respond the next morning, they have already talked to two competitors. Speed-to-lead is everything, and you are always behind."
  },
  {
    icon: TriangleAlert,
    title: "You waste time on unqualified leads",
    description: "Your team spends hours on calls with people who were never going to book. Without proper scoring and qualification, every lead gets the same treatment -- and your close rate suffers."
  },
  {
    icon: Shuffle,
    title: "Your follow-up is inconsistent",
    description: "Some leads get three texts and a call. Others fall through the cracks entirely. Manual follow-up means some homeowners get the VIP treatment and others get ghosted."
  },
  {
    icon: TrendingUp,
    title: "You can not track what is working",
    description: "Which channel drives your best leads? Google Local Services, Yelp, or your website? You are spending money on ads and directories with no clear picture of what actually fills your schedule."
  }
];
      ...
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "mt-16 max-w-2xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-neo rounded-xl p-6 text-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "of homeowners hire the first company that responds. OzziOS makes sure that's you." })
          ] }) })
        ]
      }
    ) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Most service businesses lose leads before they ever get a chance to sell. Here's where things break down." })
        ]
      }
    ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-3 card-neo rounded-full px-6 py-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "Every stage runs automatically. You only step in when a lead is ready to book." })
        ] })
      }
    )
  ] }) });
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl lg:text-5xl text-foreground tracking-tight mb-4", children: "Everything you need to fill your schedule" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Service companies using OzziOS for lead generation see measurable improvements across the entire funnel." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground tracking-tight mb-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-signature", children: "Start booking them." })
        ] }),
