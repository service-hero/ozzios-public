import { a as reactExports, n as jsxRuntimeExports } from "./worker-entry-D9YBKU4i.js";
import { L as Link } from "./router-CpnZ0YBq.js";
import { c as cn } from "./utils-QXBWQHlM.js";
import { B as Button } from "./button-9hTLAGkd.js";
import { c as createLucideIcon } from "./createLucideIcon-vrAkbvDe.js";
import { B as BookOpen, M as Menu } from "./menu-A3VZj51l.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, c as usePresence, b as useIsomorphicLayoutEffect, L as LayoutGroupContext, A as ArrowRight, m as motion } from "./proxy-DirR3PYt.js";
const __iconNode$k = [
...
const MessageSquareText = createLucideIcon("message-square-text", __iconNode$b);
const __iconNode$a = [
  [
    "path",
    {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-8", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn(
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: section.items.map((subItem) => {
                          ...
                          const linkProps = subItem.href.startsWith("/") ? { to: subItem.href, onClick: () => setActiveMenu(null) } : { href: subItem.href };
                          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            LinkOrA,
                            {
                              ...
                              children: [
                                Icon && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-9 w-9 rounded-xl bg-gray-100 flex items-center justify-center shrink-0 group-hover:bg-gray-200 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-4 w-4 text-gray-600" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-8 mt-6 border-t border-gray-200 space-y-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "https://app.ozzios.com/sign-up?plan=solo", onClick: () => setIsMobileMenuOpen(false), children: [
                  "Start free trial",
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-gray-200 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1200px] px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-16 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 md:col-span-4 lg:col-span-1 lg:pr-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-[13px] leading-relaxed text-gray-500 max-w-xs", children: "The AI-powered operating system for marketing agencies." }),
      ...
      Object.entries(footerLinks).map(([key, section]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[11px] font-semibold uppercase tracking-wider text-gray-400 mb-5", children: section.title }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-gray-200 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-between gap-4 sm:flex-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[12px] text-gray-400", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-gray-400", children: "All systems operational" })
      ] })
    ] }) })
  ] }) });
}
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: "Manage your pipeline in the built-in CRM, track tasks on kanban boards, and store knowledge in your wiki—all without scaling your retainer.",
  ...
  agency: {
    ...
    howItWorks: {
      ...
      steps: [
        {
          number: "01",
          title: "Cancel 8+ subscriptions",
          description: "Replace Mailchimp, Hootsuite, SEMrush, and more. Email campaigns, social scheduling, forms, and SEO tools are all built in.",
          benefits: ["All-in-one platform", "Email, social & SEO included"]
        },
        {
          number: "02",
          title: "Hire employees who never leave",
          description: "AI agents handle content writing, blog posts, presentations, coding reports, and ad optimization. They learn your brand voice and never quit.",
          benefits: ["Blog & presentations", "Custom reports & code"]
        },
        {
          number: "03",
          title: "Work runs while you sleep",
          description: "Automated workflows trigger email and SMS campaigns at 3am. Voice agents answer client calls. Dashboards update with live data overnight.",
          benefits: ["Voice agents & workflows", "Real-time dashboards"]
        },
        {
          number: "04",
          title: "Grow without the hiring pain",
          description: "Manage all clients in the CRM, track projects on kanban boards, share documents with e-signatures, and build knowledge bases—without adding headcount.",
          benefits: ["CRM & task management", "Documents & knowledge base"]
        }
      ]
    },
    testimonials: {
