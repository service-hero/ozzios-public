import { a as reactExports, n as jsxRuntimeExports, q as requireShim, s as commonjsGlobal } from "./worker-entry-B5eyDbT7.js";
import { u as useAudience, b as audienceContent, A as AnimatePresence, C as ChevronDown, a as MessageSquare, F as FileText, L as LandingLayout } from "./LandingLayout-DPGYOMoS.js";
import { c as createSlot, B as Button } from "./button-CdRR1kGv.js";
import "./router-CRqcsHLj.js";
import { c as cn } from "./utils-QXBWQHlM.js";
import { a as animateVisualElement, s as setTarget, u as useConstant, b as useIsomorphicLayoutEffect$1, m as motion, A as ArrowRight } from "./proxy-CClMHKlh.js";
import { P as Play } from "./play-BEIe5iqE.js";
import { S as Star, a as Settings } from "./star-CL9RM-KK.js";
import { H as Hash } from "./hash-sCoLKmxU.js";
import { M as Menu } from "./menu-CRWpwPmx.js";
...
import { S as Send } from "./send-BNqo3P3g.js";
const __iconNode = [
  [
    "path",
    {
...
const BentoSection = reactExports.lazy(
  () => import("./BentoSection-D-bTGcka.js").then((m) => ({ default: m.BentoSection }))
);
const ComparisonSection = reactExports.lazy(
  () => import("./ComparisonSection-fwA-oFEV.js").then((m) => ({ default: m.ComparisonSection }))
);
const FeaturesShowcaseSection = reactExports.lazy(
  () => import("./FeaturesShowcaseSection-CyTO-ZoW.js").then((m) => ({
    default: m.FeaturesShowcaseSection
  }))
);
const SavingsCalculatorSection = reactExports.lazy(
  () => import("./SavingsCalculatorSection-DqP_OiLZ.js").then((m) => ({
    default: m.SavingsCalculatorSection
  }))
);
const FeaturesSection = reactExports.lazy(
  () => import("./HowItWorksSection-DXkPuZBA.js").then((m) => ({ default: m.FeaturesSection }))
);
const AgentsSection = reactExports.lazy(
  () => import("./AgentsSection-SozH7fGb.js").then((m) => ({ default: m.AgentsSection }))
);
const MemorySection = reactExports.lazy(
  () => import("./MemorySection-Ba6NAHBc.js").then((m) => ({ default: m.MemorySection }))
);
const PricingSection = reactExports.lazy(
  () => import("./PricingSection-BCaERjjT.js").then((m) => ({ default: m.PricingSection }))
);
const IntegrationsSection = reactExports.lazy(
  () => import("./IntegrationsSection-C3txBani.js").then((m) => ({
    default: m.IntegrationsSection
  }))
);
const TestimonialsSection = reactExports.lazy(
  () => import("./TestimonialsSection-B5G2kkdg.js").then((m) => ({
    default: m.TestimonialsSection
  }))
);
const FAQSection = reactExports.lazy(
  () => import("./FAQSection-D1kq5PSl.js").then((m) => ({ default: m.FAQSection }))
);
const CTASection = reactExports.lazy(
  () => import("./CTASection-8dy930kh.js").then((m) => ({ default: m.CTASection }))
);
