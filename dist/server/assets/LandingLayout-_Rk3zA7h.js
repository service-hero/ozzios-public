import { a as reactExports, n as jsxRuntimeExports } from "./worker-entry-DIC8UpJI.js";
import { L as Link } from "./router-kXCOQ41n.js";
import { c as cn } from "./utils-QXBWQHlM.js";
import { B as Button } from "./button-Cce7Ah0G.js";
import { c as createLucideIcon } from "./createLucideIcon-CxWayAC-.js";
import { B as BookOpen, M as Menu } from "./menu-2JpqeIYT.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, c as usePresence, b as useIsomorphicLayoutEffect, L as LayoutGroupContext, A as ArrowRight, m as motion } from "./proxy-CBHrjLyJ.js";
const __iconNode$k = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border/40 bg-background pt-8 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1400px] px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-16 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 md:col-span-4 lg:col-span-1 lg:pr-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-[13px] leading-relaxed text-muted-foreground max-w-xs font-light", children: "The enterprise AI marketing platform. Replace your entire stack with specialized agents that work 24/7." }),
