...
import { j as Code, S as Share2, B as Brain, A as AnimatePresence, L as LandingLayout } from "./LandingLayout-BbzH_Y3t.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative pt-32 pb-16 lg:pt-40 lg:pb-20 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: "hidden", animate: "visible", variants: containerVariants, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "text-center mb-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-2xl mx-auto mb-8", children: "Your AI agents generate interactive React dashboards and reports in isolated sandboxes. Get a shareable URL and send it straight to your customer -- no developers, no static PDFs." }),
...
function SolutionSection() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "The app runs instantly in an isolated E2B sandbox. See exactly what your customer will see -- interactive charts, responsive layout, live data -- before sharing."
    },
    {
      step: "03",
