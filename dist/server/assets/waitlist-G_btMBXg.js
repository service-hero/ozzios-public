import { r as reactExports, j as jsxRuntimeExports, m as motion } from "./vendor-framer-DZFBeC81.js";
import { B as Button, c as cn } from "./button-DuL_ysbl.js";
import { I as Input } from "./input-DGfSt9KJ.js";
import { L as Label, C as Checkbox } from "./checkbox-3uKsNYqo.js";
import { Q as Quote, A as ArrowRight, C as CircleCheck } from "./vendor-icons-RMyvaHp0.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "max-w-3xl mx-auto px-6 pt-20 pb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl sm:text-5xl font-bold text-foreground tracking-tight leading-[1.15] mb-6", children: "What if your growing service company had a full back-office team on day one?" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "max-w-3xl mx-auto px-6 pb-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prose prose-neutral dark:prose-invert max-w-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold text-foreground mb-6", children: "The home service business model is broken." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "I've spent years working with home service companies, and I've watched the same pattern hold businesses back over and over again." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "You land a big job. You need to hire more techs. You train them for weeks. They finally become productive. Then they leave. Or the seasonal slowdown hits. Or both happen at the same time, and suddenly you're paying for a team with not enough work to keep them busy." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "The math never works. Here's what most service business owners don't talk about:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 my-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Every missed call costs you $200-500 in lost revenue." }),
              " And when you're on a job site, every call goes to voicemail."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Office staff costs $40,000-55,000/year each." }),
              " A dispatcher, a receptionist, a bookkeeper—that's over $120,000 before benefits."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Your best techs get poached." }),
              " The ones who finally know your systems, your customers, your standards—they're the first to leave for a bigger company."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Growth is capped by your back office." }),
              " You can only take on as many jobs as you can schedule, dispatch, follow up on, and invoice."
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "And that's before we talk about the tool sprawl. The average home service company uses 5-8 different software products. ServiceTitan or Housecall Pro for scheduling. QuickBooks for invoicing. Google Sheets for tracking leads. A CRM you never update. Some social media tool you signed up for and forgot about. Each one adds friction, costs money, and creates another place where information gets lost." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground leading-relaxed font-medium", children: "I got tired of watching great tradespeople struggle with this. So I decided to change the game entirely." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-16 py-12 border-y border-border", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "When you sign up, you're not getting another dashboard to check. You're getting employees. AI employees who specialize in the exact roles your service business needs—and who never quit, never call in sick, never need a raise, and never take your best customers with them when they leave." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "my-8 space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-wider text-muted-foreground mb-3 font-medium", children: "Operations Agents — Handle your daily business" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-wider text-muted-foreground mb-3 font-medium", children: "Executive Agents — Business-wide oversight" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "And here's what makes this different from every other AI tool you've tried: they remember everything. Every customer preference. Every past conversation. Every job detail. They build up institutional knowledge that used to walk out the door every time an employee left." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-16", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "Each service area or location gets its own channel. Your AI employees are assigned to that channel and immediately have context about that area—the customer base, seasonal patterns, local competition, service history. When you @mention an employee, they get to work." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "my-8 p-6 rounded-lg border border-border bg-muted/20", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-foreground", children: [
              ...
              " @Customer-Follow-Up send review requests to every customer we serviced this week. Personalize each one with the job we completed."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm italic", children: "The Customer Follow-Up Specialist pulls the week's completed jobs, drafts personalized review requests for each customer, and sends them—usually within minutes." })
          ] })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 my-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Schedule and dispatch jobs" }),
              " — They don't just tell you what to do. They book the appointment, assign the tech, and send the confirmation."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Follow up on quotes and send reminders" }),
              " — Connected to your CRM. They chase leads so you don't have to."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Generate customer reports and invoices" }),
              " — Job summaries, payment tracking, and revenue reports you can review in seconds."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Manage your online presence" }),
              " — Google Business Profile, review responses, social media posts, and local SEO."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "my-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-4", children: "Here's what this looks like in practice — the Dispatch Coordinator and Customer Follow-Up Specialist collaborating on a service project:" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-16 py-12 border-y border-border", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: `Think about what this means: you're no longer managing individual tasks or individual employees. You're managing outcomes. You say "I need to launch a seasonal AC tune-up campaign across all our service areas" and the Supervisor coordinates the marketing, the scheduling, the customer outreach, and the follow-ups—across multiple AI employees—without you having to orchestrate any of it.` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground leading-relaxed font-medium", children: "It's like having an operations manager who works 24/7 and never drops the ball." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-16", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "On the left, you have a Task Pool with pre-built templates for everything your AI employees can do: follow up on quotes, request reviews, schedule maintenance reminders, post to social media, send payment reminders. Drag a task onto an employee's timeline and it's scheduled." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "Tasks can be one-time or recurring. Set your Dispatch Coordinator to optimize routes every morning. Have your Customer Follow-Up Specialist send review requests every afternoon. Your Marketing Manager can post before-and-after photos every Wednesday." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-16 py-12 border-y border-border", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "Beyond scheduling, we built a professional-grade workflow engine into OzziOs. Not because automation is trendy, but because the combination of AI employees + automation creates something genuinely new." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "When a new service request comes in, you can automatically:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { className: "space-y-3 my-6 list-decimal list-inside", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-muted-foreground pl-2", children: "Have an AI employee qualify the lead and gather job details" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-muted-foreground pl-2", children: "Check technician availability and schedule the appointment" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-muted-foreground pl-2", children: "Send the customer a confirmation with tech details and arrival window" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-muted-foreground pl-2", children: "After the job, trigger a review request and follow-up survey" })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "my-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-4", children: "Here's a workflow that handles a new service request end-to-end—from lead qualification to post-job follow-up:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-border overflow-hidden shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Multiple AI employees can work on different parts of a job simultaneously, and their outputs merge automatically. It's like having an operations team that can tackle every aspect of a service request at once." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-16 py-12 border-y border-border", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-16", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "A full-time office manager costs $45,000-55,000/year in salary alone. Add a dispatcher, a bookkeeper, and a part-time marketing person, and you're looking at $150,000-200,000 in total overhead—before benefits and equipment." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "Those employees work 40 hours a week—2,080 hours a year—minus vacation, sick days, and all the other time that isn't actual productive work. Realistically, you get maybe 1,200 hours of real output from each." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "An AI employee on OzziOs works 24/7/365. That's 8,760 hours of availability. They don't take breaks. They don't get distracted. They don't need to be managed. And they cost a fraction of what human office staff costs." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "my-8 p-6 rounded-lg border border-border bg-muted/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-semibold text-foreground mb-4", children: "The real math:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "If you're a growing service company and you can automate 65% of the repetitive, process-driven back-office work with AI employees, you can deliver the same customer experience with a fraction of the office staff. The people who remain focus on complex customer issues, in-person relationships, and growing the business—the work that actually requires human judgment." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground leading-relaxed font-medium", children: "This isn't about replacing people. It's about freeing you to focus on the work that matters." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-16 py-12 border-y border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold text-foreground mb-6", children: "Who this is for." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "OzziOs is built for home service companies, but the model applies anywhere you have back-office operations eating into your margins:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 my-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "HVAC, plumbing, and electrical" }),
              " — Scheduling, dispatch, maintenance reminders, emergency response"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Roofing and exterior services" }),
              " — Storm response, inspection scheduling, insurance coordination"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Landscaping and cleaning" }),
              " — Recurring service management, route optimization, seasonal campaigns"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-foreground mt-2.5 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Pest control, painting, and general contracting" }),
              " — Lead management, quote follow-ups, customer retention"
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "If you're tired of missed calls, if you're paying for 5 different tools that don't talk to each other, if you want to grow without the chaos—this is for you." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-16", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "The technology finally exists to build AI that doesn't just answer questions—it does work. Real, substantive, valuable work that used to require someone sitting at a desk answering phones and managing schedules." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "We're at an inflection point. The service companies that figure this out first will have an insurmountable advantage. They'll be able to take on more jobs, deliver better customer experiences, and grow faster—while their competitors are still letting calls go to voicemail and forgetting to follow up on quotes." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mb-16 py-12 border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "I don't know if OzziOs will be the platform that defines this new era. But I know the era is coming. The question isn't whether AI will change how service businesses operate—it's whether you'll be leading that change or reacting to it." }),
