...
import { S as Shield, G as Globe, c as Clock, L as Lock, K as KeyRound, d as Server, F as FileCheck, E as Eye, C as CircleCheck, A as ArrowRight } from "./vendor-icons-RMyvaHp0.js";
...
const securitySections = [
  ...
  },
  {
    ...
    description: "Built on professional-grade infrastructure with automatic scaling, redundancy, and geographic distribution. Continuous monitoring detects and responds to threats in real time.",
    practices: [
  ...
  },
  {
    ...
    description: "We take a privacy-first approach to data handling. Your customer data belongs to you. We process it only as instructed and never sell or share it with third parties.",
    practices: [
      ...
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "text-center mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tag-neo rounded-full bg-signature/10 border-signature mb-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold text-signature uppercase tracking-wider", children: "Professional-Grade Security" })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-2xl mx-auto", children: "Your business handles sensitive customer data. We built OzziOS with security as a foundation, not an afterthought. Every layer of the platform is designed to keep your data safe." })
        ] })
      }
    ) }) }),
