import { a as reactExports, n as jsxRuntimeExports, q as requireShim, s as commonjsGlobal } from "./worker-entry-3gbtrwAd.js";
import { u as useAudience, a as audienceContent, A as AnimatePresence, C as ChevronDown, M as MessageSquare, F as FileText, B as Bot, U as Users, W as Workflow, b as ChartColumn, L as LandingLayout } from "./LandingLayout-DBLbOmWw.js";
import { c as createSlot, B as Button } from "./button-Dh_ejiKz.js";
import "./router-XURZgIWD.js";
import { c as cn } from "./utils-QXBWQHlM.js";
import { a as animateVisualElement, s as setTarget, u as useConstant, b as useIsomorphicLayoutEffect$1, r as resolveElements, m as motion, A as ArrowRight } from "./proxy-DsobtX3y.js";
import { c as createLucideIcon } from "./createLucideIcon-B3BVHTxy.js";
import { Z as Zap } from "./zap-D8V4s-ka.js";
import { M as Menu, S as Sparkles } from "./sparkles-CB8QHL5C.js";
import { S as Search } from "./search-J2AbUiZ1.js";
import { C as CircleCheck, Q as Quote } from "./quote-7s1GlAjm.js";
import { C as Check } from "./check-ZonzdHht.js";
import { T as TrendingUp } from "./trending-up-FJe2n4xn.js";
import "node:events";
...
const getAgentOrbState$1 = (message, isStreaming, isStreamingComplete) => {
...
function HeroSection() {
  ...
  reactExports.useEffect(() => {
    ...
    const timer = setTimeout(showMessages, 400);
    return () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pointer-events-none opacity-40 grid-pattern" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-20 right-10 lg:right-20 w-32 h-32 border-4 border-signature/20 pointer-events-none hidden lg:block" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-32 right-24 lg:right-36 w-16 h-16 bg-signature/10 pointer-events-none hidden lg:block" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-40 left-10 lg:left-20 w-24 h-24 border-4 border-electric/20 pointer-events-none hidden lg:block" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-32 left-20 lg:left-32 w-12 h-12 bg-electric/10 pointer-events-none hidden lg:block" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 w-full mx-auto max-w-[1400px] px-6 lg:px-8 pt-32 pb-20 lg:pt-40 lg:pb-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$6, className: "mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-0 border-2 border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    onClick: () => setAudience("business"),
                    className: `flex items-center gap-2 px-5 py-2.5 text-[12px] font-semibold uppercase tracking-wider transition-all duration-150 ${isBusinessOwner ? "bg-signature text-white" : "bg-transparent text-foreground/50 hover:text-foreground hover:bg-muted"}`,
                    children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    className: `flex items-center gap-2 px-5 py-2.5 text-[12px] font-semibold uppercase tracking-wider transition-all duration-150 ${isAgency ? "bg-electric text-white" : "bg-transparent text-foreground/50 hover:text-foreground hover:bg-muted"}`,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "w-3.5 h-3.5" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Agency" })
                    ]
                  }
                )
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$6, className: "mb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-1.5 border-2 border-mint text-mint", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-3.5 h-3.5" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-widest", children: "SOC 2" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-1.5 border-2 border-signature text-signature", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-3.5 h-3.5" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-widest", children: "Enterprise" })
                ] })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$6, className: "text-center max-w-5xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.h1,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative inline-block text-signature underline-signature", children: content.headline[1] })
                  ]
                },
                audience
              ) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.p,
                {
                  ...
                  className: "mt-8 text-lg sm:text-xl text-foreground/60 leading-relaxed max-w-2xl text-center",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        size: "lg",
                        asChild: true,
                        className: "h-14 px-8 text-[14px] font-semibold uppercase tracking-wider gap-3 bg-foreground text-background hover:bg-foreground/90 rounded-none btn-neo group",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Button,
                      {
                        variant: "outline",
                        size: "lg",
                        className: "h-14 px-8 text-[14px] font-semibold uppercase tracking-wider gap-3 border-2 border-border text-foreground hover:bg-muted rounded-none group",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex items-center justify-center w-8 h-8 border-2 border-current", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "h-3 w-3 fill-current ml-0.5" }) }),
                          "Watch Demo"
                        ]
                      }
                    )
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  variants: itemVariants$6,
                  className: "mt-20 flex flex-wrap items-center justify-center gap-x-16 gap-y-8",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.div,
                    {
                      ...
                      children: content.stats.map((stat, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center relative", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl sm:text-4xl font-display text-foreground", children: stat.value }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-[11px] text-foreground/50 uppercase tracking-widest font-medium", children: stat.label }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            className: `absolute -bottom-2 left-1/2 -translate-x-1/2 w-8 h-1 ${index === 0 ? "bg-signature" : index === 1 ? "bg-electric" : "bg-mint"}`
                          }
                        )
                      ] }, stat.label))
                    },
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative border-2 border-border bg-card overflow-hidden shadow-neo-lg", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-3 border-b-2 border-border bg-muted", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 rounded-full bg-signature" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 rounded-full bg-sun" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 rounded-full bg-mint" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-1.5 border-2 border-border bg-background", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-mint" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-foreground/50 font-mono font-medium", children: "app.ozzios.com" })
                      ] }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[3/4] sm:aspect-[4/3] md:aspect-[16/9] bg-background flex overflow-hidden", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex w-[70px] flex-col items-center py-3 gap-2 border-r-2 border-border bg-muted z-20", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative flex items-center justify-center w-12 h-12 mb-2 cursor-pointer", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 w-1 h-8 bg-signature" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-electric flex items-center justify-center transition-all duration-150", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "w-6 h-6 text-white" }) })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-border mb-2" }),
                        ["A", "C", "D"].map((letter, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative flex items-center justify-center w-12 h-12 cursor-pointer", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 w-1 h-0 bg-foreground opacity-0 group-hover:h-5 group-hover:opacity-100 transition-all duration-150" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-12 h-12 border-2 border-border flex items-center justify-center transition-all duration-150 group-hover:border-transparent ${i === 0 ? "group-hover:bg-mint" : i === 1 ? "group-hover:bg-electric" : "group-hover:bg-signature"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground/50 group-hover:text-white", children: letter }) })
                        ] }, letter)),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto group flex items-center justify-center w-12 h-12 cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 border-2 border-dashed border-border flex items-center justify-center transition-all duration-150 group-hover:border-mint group-hover:bg-mint/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-6 h-6 text-foreground/30 group-hover:text-mint" }) }) })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex w-56 flex-col border-r-2 border-border bg-muted", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 border-b-2 border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-signature flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-white", children: "AC" }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[12px] font-bold text-foreground truncate", children: "Acme Agency" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 bg-mint" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-foreground/50", children: "Online" })
                            ] })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-3.5 h-3.5 text-foreground/30" })
                        ] }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-hidden py-3", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-[9px] font-bold text-foreground/40 uppercase tracking-widest", children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0.5 px-2", children: sidebarChannels.map((channel) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "div",
                            {
                              ...
                              className: `flex items-center gap-2 px-2 py-1.5 text-[11px] transition-all duration-150 ${channel.name === activeChannel ? "bg-signature text-white font-semibold" : channel.hasMessages ? "text-foreground/60 hover:bg-background hover:text-foreground cursor-pointer" : "text-foreground/30"}`,
                              children: [
                                channel.starred && /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-3 h-3 fill-current" }),
                                ...
                                channel.hasMessages && channel.name !== activeChannel && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto w-2 h-2 bg-signature" })
                              ]
                            },
                            channel.name
                          )) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 mt-4 mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-[9px] font-bold text-foreground/40 uppercase tracking-widest", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-3 h-3" }),
                            "Team"
                          ] }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0.5 px-2", children: sidebarTeam.map((member) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "div",
                            {
                              className: "flex items-center gap-2 px-2 py-1.5 text-[11px] text-foreground/60 hover:bg-background",
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                                  ...
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "div",
                                    {
                                      className: `absolute -bottom-0.5 -right-0.5 w-2 h-2 ${member.status === "online" ? "bg-mint" : "bg-sun"}`
                                    }
                                  )
                                ] }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: member.name }),
                                member.isAgent && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-[8px] px-1.5 py-0.5 bg-electric text-white font-bold", children: "AI" })
                              ]
                            },
                            member.name
                          )) })
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0 min-h-0 overflow-hidden", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-between px-3 sm:px-4 py-2 border-b-2 border-border", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "button",
                            {
                              onClick: () => setMobileMenuOpen(!mobileMenuOpen),
                              className: "flex md:hidden items-center gap-2 hover:bg-muted px-1.5 py-1 -ml-1.5 transition-colors",
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "w-4 h-4 text-foreground/50" }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(Hash, { className: "w-3.5 h-3.5 text-foreground/50" }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px] font-bold text-foreground truncate max-w-[120px]", children: activeChannel }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: `w-3 h-3 text-foreground/30 transition-transform ${mobileMenuOpen ? "rotate-180" : ""}` })
                              ]
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-2", children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Hash, { className: "w-4 h-4 text-foreground/50" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-bold text-foreground", children: activeChannel })
                          ] }),
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:flex items-center -space-x-2", children: [
                              sidebarTeam.slice(0, 3).map((member, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "div",
                                {
                                  ...
                                  ) : /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: member.image, alt: "", className: "w-6 h-6 object-cover" })
                                },
                                member.name
                              )),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 border-2 border-border bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold text-foreground/50", children: "+4" }) })
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "w-4 h-4 text-foreground/30 hidden sm:block" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "w-4 h-4 text-foreground/30 hidden sm:block" })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: mobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
                            motion.div,
                            {
                              ...
                              className: "absolute top-full left-0 right-0 z-50 bg-background border-b-2 border-border shadow-neo md:hidden",
                              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 space-y-0.5", children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 py-1.5 text-[9px] font-bold text-foreground/40 uppercase tracking-widest", children: "Channels" }),
                                sidebarChannels.map((channel) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                  "button",
                                  {
                                    ...
                                    className: `w-full flex items-center gap-2 px-2 py-2 text-[12px] transition-all ${channel.name === activeChannel ? "bg-signature text-white font-semibold" : channel.hasMessages ? "text-foreground/60 hover:bg-muted hover:text-foreground" : "text-foreground/30 cursor-not-allowed"}`,
                                    children: [
                                      channel.starred && /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-3.5 h-3.5 fill-current" }),
                                      /* @__PURE__ */ jsxRuntimeExports.jsx(Hash, { className: "w-3.5 h-3.5" }),
                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: channel.name }),
                                      channel.hasMessages && channel.name !== activeChannel && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto w-2 h-2 bg-signature" }),
                                      channel.name === activeChannel && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-[8px] px-1.5 py-0.5 bg-white/20 text-white font-bold", children: "Active" })
                                    ]
                                  },
                                  channel.name
                                ))
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-0 px-4 py-2 border-b-2 border-border", children: [
                          ...
                          { icon: Sparkles, label: "Creations", active: false }
                        ].map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            className: `flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-medium border-b-2 -mb-[10px] ${tab.active ? "border-signature text-foreground" : "border-transparent text-foreground/40 hover:text-foreground/60"}`,
                            children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: messagesContainerRef, className: "flex-1 min-h-0 overflow-y-auto overflow-x-hidden p-3 sm:p-4 space-y-4 scrollbar-hidden", children: [
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 overflow-hidden", children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-1 sm:gap-2 mb-1", children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] sm:text-[12px] font-bold text-foreground truncate max-w-[100px] sm:max-w-none", children: message.user }),
                                    message.isAgent && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] sm:text-[9px] px-1.5 py-0.5 bg-electric text-white font-bold", children: "AI" }),
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] sm:text-[10px] text-foreground/40 shrink-0", children: message.time })
                                  ] }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] sm:text-[12px] text-foreground/70 leading-relaxed break-words overflow-hidden", children: (() => {
                                    if (message.isAgent) {
                                      ...
                                      return message.content.map((part, i) => {
                                        if (part.type === "text" && part.text) {
                                          ...
                                          return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline", children: [
                                            ...
                                            showCursor && /* @__PURE__ */ jsxRuntimeExports.jsx(
                                              "span",
                                              {
                                                className: "inline-block ml-0.5 align-middle text-signature",
                                                style: {
                                        ...
                                        if (part.type === "mention") {
                                          return /* @__PURE__ */ jsxRuntimeExports.jsx(
                                            "span",
                                            {
                                              className: "inline-flex items-center px-1.5 py-0.5 bg-electric text-white font-semibold",
                                              children: part.text
                                            },
                                            i
                                          );
                                        ...
                                        if (part.type === "metrics" && "items" in part) {
                                          ...
                                          return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `my-2 grid gap-1.5 sm:gap-2 grid-cols-2 ${items.length === 4 ? "sm:grid-cols-4" : "sm:grid-cols-4 lg:grid-cols-5"}`, children: items.map((item, j) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                            "div",
                                            {
                                              className: "p-2 border-2 border-border bg-background text-center",
                                              children: [
                                                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-foreground/50 mb-1 uppercase tracking-wider font-medium", children: item.label }),
                                                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[13px] text-foreground font-bold", children: item.value }),
                                                item.change && /* @__PURE__ */ jsxRuntimeExports.jsx(
                                                  "div",
                                                  {
                                                    className: `text-[9px] mt-0.5 font-semibold ${item.change.startsWith("+") ? "text-mint" : item.change.startsWith("-") ? "text-mint" : "text-foreground/40"}`,
                                        ...
                                        if (part.type === "images" && "items" in part) {
                                          ...
                                          return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-2 flex flex-wrap gap-2", children: part.items.map((item, j) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                            "div",
                                            {
                                              className: `relative ${item.wide ? "w-full sm:w-48 h-20 sm:h-24" : "w-16 sm:w-20 h-16 sm:h-20"} overflow-hidden group border-2 border-border`,
                                              children: [
                                                ...
                                                item.placeholder && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 flex items-center justify-center text-[10px] font-bold text-white bg-black/30", children: item.placeholder })
                                              ]
                                            },
                                            j
                                          )) }, i);
                                        ...
                                        if (part.type === "videos" && "items" in part) {
                                          ...
                                          return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-2 flex flex-wrap gap-2", children: part.items.map((item, j) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                            "div",
                                            {
                                              className: "relative w-16 sm:w-20 h-16 sm:h-20 overflow-hidden group cursor-pointer border-2 border-border",
                                              children: [
                                                ...
                                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center", children: [
                                                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 bg-white flex items-center justify-center mb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-0 h-0 border-t-[6px] border-t-transparent border-l-[10px] border-l-foreground border-b-[6px] border-b-transparent ml-1" }) }),
                                                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold text-white", children: item.duration })
                                                ] })
                                              ]
                                            },
                                            j
                                        ...
                                        if (part.type === "actions" && "items" in part) {
                                          ...
                                          return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-2 space-y-1.5", children: part.items.map((item, j) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                            "div",
                                            {
                                              className: "flex flex-wrap items-center gap-1.5 sm:gap-2 p-2 border-2 border-border bg-background",
                                              children: [
                                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px]", children: item.icon }),
                                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold text-[11px]", children: item.action }),
                                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline text-foreground/40 text-[10px]", children: "-" }),
                                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline text-foreground/50 text-[10px] truncate max-w-[150px]", children: item.detail }),
                                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `ml-auto text-[9px] px-1.5 py-0.5 font-bold shrink-0 ${item.status === "success" ? "bg-mint text-white" : "bg-electric text-white"}`, children: item.status === "success" ? "Done" : "Info" })
                                              ]
                                            },
                                            j
                                          )) }, i);
                                        ...
                                        if (part.type === "keywords" && "items" in part) {
                                          ...
                                          return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-2 space-y-1.5", children: part.items.map((item, j) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                            "div",
                                            {
                                              className: "flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3 p-2 border-2 border-border bg-background",
                                              children: [
                                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-foreground text-[11px] font-semibold truncate", children: item.keyword }),
                                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
                                                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-foreground/50 font-medium", children: [
                                                    item.volume,
                                                    "/mo"
                                                  ] }),
                                                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-[9px] px-1.5 py-0.5 font-bold ${parseInt(item.difficulty) < 25 ? "bg-mint text-white" : parseInt(item.difficulty) < 40 ? "bg-sun text-foreground" : "bg-signature text-white"}`, children: [
                                                    "KD: ",
                                                    item.difficulty
                                                  ] }),
                                                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] px-1.5 py-0.5 bg-electric text-white font-bold", children: item.intent })
                                                ] })
                                              ]
                                            },
                                            j
                                        ...
                                        if (part.type === "code" && "content" in part) {
                                          const shouldShow = !message.isAgent || streamingComplete[message.id];
                                          if (!shouldShow) return null;
                                          return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-2 p-2 sm:p-3 border-2 border-border bg-foreground font-mono text-[9px] sm:text-[10px] text-mint whitespace-pre-wrap break-all overflow-hidden", children: part.content }, i);
                                        }
                                        if (part.type === "preview" && "url" in part) {
                                          ...
                                          return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                            "a",
                                            {
                                              ...
                                              className: "block group border-2 border-border hover:border-signature transition-colors duration-150",
                                              children: [
                                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative p-3 bg-muted", children: [
                                                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
                                                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                                                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 bg-signature flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[7px] font-bold text-white", children: "A" }) }),
                                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold text-foreground", children: "Acme Agency Report" })
                                                    ] }),
                                                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 px-1.5 py-0.5 bg-mint", children: [
                                                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-1 bg-white animate-pulse" }),
                                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[7px] font-bold text-white", children: "LIVE" })
                                                    ] })
                                                  ] }),
                                                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-1.5 mb-3", children: [
                                                    { label: "Revenue", value: "$124K", color: "text-mint" },
                                                    { label: "ROAS", value: "4.8x", color: "text-electric" },
                                                    { label: "Visitors", value: "47K", color: "text-violet-400" },
                                                    { label: "Conv.", value: "3.2%", color: "text-signature" }
                                                  ].map((metric) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-1.5 border-2 border-border bg-background", children: [
                                                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[6px] text-foreground/50 uppercase font-bold", children: metric.label }),
                                                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-[10px] font-bold ${metric.color}`, children: metric.value })
                                                  ] }, metric.label)) }),
                                                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 border-2 border-border bg-background mb-2", children: [
                                                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
                                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[7px] font-bold text-foreground/60", children: "Revenue by Channel" }),
                                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[6px] text-foreground/40", children: "Last 30 days" })
                                                    ] }),
                                                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end gap-1 h-8", children: [65, 45, 80, 55, 90, 70, 85, 60, 95, 75, 88, 72].map((height, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                                                      "div",
                                                      {
                                                        className: "flex-1 bg-signature",
                                                        style: { height: `${height}%` }
                                                      },
                                                      idx
                                                    )) })
                                                  ] }),
                                                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-2 border-border bg-background overflow-hidden", children: [
                                                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2 px-2 py-1 bg-muted border-b-2 border-border", children: [
                                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[6px] font-bold text-foreground/50 uppercase", children: "Channel" }),
                                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[6px] font-bold text-foreground/50 uppercase text-right", children: "Revenue" }),
                                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[6px] font-bold text-foreground/50 uppercase text-right", children: "ROI" })
                                                    ] }),
                                                    [
                                                      { channel: "Facebook Ads", revenue: "$48.2K", roi: "+312%" },
                                                      { channel: "Google Ads", revenue: "$31.4K", roi: "+245%" },
                                                      { channel: "Email", revenue: "$28.1K", roi: "+890%" }
                                                    ].map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2 px-2 py-1 border-b border-border last:border-0", children: [
                                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[7px] text-foreground/70", children: row.channel }),
                                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[7px] text-foreground font-bold text-right", children: row.revenue }),
                                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[7px] text-mint font-bold text-right", children: row.roi })
                                                    ] }, row.channel))
                                                  ] })
                                                ] }),
                                                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2.5 border-t-2 border-border bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                                                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                                                    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[11px] font-bold text-foreground truncate group-hover:text-signature transition-colors", children: previewData.title }),
                                                    /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-3 h-3 text-foreground/30 group-hover:text-signature group-hover:translate-x-0.5 transition-all" })
                                                  ] }),
                                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-foreground/50 mt-0.5 truncate font-mono", children: previewData.url })
                                                ] }) }) })
                                              ]
                                            }
                                          ) }, i);
                                  ...
                                  message.reactions && (!message.isAgent || streamingComplete[message.id]) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 mt-2", children: message.reactions.map((reaction, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                    "div",
                                    {
                                      className: "flex items-center gap-1 px-2 py-0.5 border-2 border-border bg-background",
                                      children: [
                                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px]", children: reaction.emoji }),
                                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-foreground/60 font-semibold", children: reaction.count })
                                      ]
                                    },
                                    i
                                  )) })
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isTyping && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            motion.div,
                            {
                              ...
                              animate: { opacity: 1, y: 0 },
                              exit: { opacity: 0, y: -8 },
                              className: "flex items-center gap-2 text-[11px] text-foreground/50",
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-signature animate-bounce", style: { animationDelay: "0ms" } }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-signature animate-bounce", style: { animationDelay: "150ms" } }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-signature animate-bounce", style: { animationDelay: "300ms" } })
                                ] }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "AI Agent typing..." })
                              ]
                            }
                          ) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: messagesEndRef })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 pt-3 pb-2 border-t-2 border-border", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-2 overflow-x-auto scrollbar-hidden", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-foreground/40 font-bold uppercase tracking-wider shrink-0", children: "Try:" }),
                            (activeChannel === "seo-campaigns" ? [
                              { label: "Run site audit", icon: ">" },
                              { label: "Find keywords", icon: ">" },
                              { label: "Check rankings", icon: ">" },
                              { label: "Fix errors", icon: ">" }
                            ] : activeChannel === "reports" ? [
                              { label: "Monthly report", icon: ">" },
                              { label: "ROI analysis", icon: ">" },
                              { label: "Competitor report", icon: ">" },
                              { label: "Client dashboard", icon: ">" }
                            ] : [
                              { label: "Check ad performance", icon: ">" },
                              { label: "Generate video ads", icon: ">" },
                              { label: "Update WordPress", icon: ">" },
                              { label: "Analyze ROI", icon: ">" }
                            ]).map((chip) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "button",
                              {
                                onClick: () => handleChannelChange(activeChannel),
                                className: "group flex items-center gap-1.5 px-2.5 py-1.5 border-2 border-border hover:border-signature hover:bg-signature hover:text-white transition-all duration-150 shrink-0",
                                children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-foreground/60 group-hover:text-white font-semibold whitespace-nowrap", children: chip.label })
                              },
                              chip.label
                            ))
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-2 border-2 border-border bg-background", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] text-foreground/40 font-medium", children: [
                              "Message #",
                              activeChannel
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-2", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 border-2 border-border flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-foreground/40 font-bold", children: "@" }) }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "w-4 h-4 text-foreground/30" })
                            ] })
                          ] })
                        ] })
                      ] })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-[10px] font-bold text-foreground/30 uppercase tracking-[0.3em] mb-10", children: "Trusted by leading agencies" }),
                      ...
                      motion.div,
                      {
                        ...
                        children: [...enterpriseLogos, ...enterpriseLogos].map((logo, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-foreground/20 tracking-widest whitespace-nowrap uppercase", children: logo.name })
                          },
                          `${logo.name}-${i}`
                        ))
                      }
    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] rounded-full blur-[150px] opacity-[0.03] pointer-events-none glow-amber-soft"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants$5, className: "mb-20 max-w-3xl", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-semibold text-amber-400/80 uppercase tracking-[0.2em] mb-4", children: content.sectionLabel }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-[clamp(2rem,5vw,3.5rem)] font-display leading-[1.1] tracking-[-0.02em] text-foreground mb-6", children: [
                  content.headline[0],
                  /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/30", children: content.headline[1] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-foreground/40 leading-relaxed max-w-xl", children: content.subheadline })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$5, className: "col-span-12 lg:col-span-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BentoCard, { className: "h-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row h-full", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative lg:w-2/5 h-48 lg:h-auto min-h-[200px]", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-transparent to-background hidden lg:block" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-background to-transparent lg:hidden" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-8 lg:p-10 flex flex-col", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/20 mb-6 w-fit", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold text-amber-400 uppercase tracking-wider", children: content.cards.aiWorkforce.badge })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl lg:text-3xl font-display text-foreground mb-3", children: content.cards.aiWorkforce.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] text-foreground/40 leading-relaxed mb-6", children: content.cards.aiWorkforce.description }),
                      ...
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-foreground/30 uppercase tracking-wider", children: agent.status })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] font-medium text-foreground/70 group-hover:text-foreground transition-colors", children: agent.name })
                        ]
                      },
                      agent.name
                    )) })
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$5, className: "col-span-12 sm:col-span-6 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BentoCard, { className: "h-full overflow-hidden", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 lg:p-8 -mt-8 relative z-10", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-display text-foreground mb-2", children: content.cards.tools.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] text-foreground/40 leading-relaxed mb-4", children: content.cards.tools.description }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$5, className: "col-span-12 sm:col-span-6 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BentoCard, { className: "h-full overflow-hidden", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 lg:p-8 -mt-6 relative z-10", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-12 rounded-xl bg-violet-500/10 border border-violet-500/20 flex items-center justify-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-5 w-5 text-violet-400" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-display text-foreground mb-2", children: content.cards.communication.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] text-foreground/40 leading-relaxed mb-4", children: content.cards.communication.description }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: ["Channels", "Forums", "Voice", "Roles"].map((feature) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: "px-2.5 py-1 text-[11px] font-medium text-foreground/40 bg-white/[0.03] rounded-md border border-white/[0.06]",
                        children: feature
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$5, className: "col-span-12 lg:col-span-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BentoCard, { className: "h-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row-reverse h-full", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative lg:w-2/5 h-48 lg:h-auto min-h-[200px]", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-l from-transparent to-background hidden lg:block" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-background to-transparent lg:hidden" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-8 lg:p-10", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-display text-foreground mb-3", children: content.cards.workflows.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] text-foreground/40 leading-relaxed mb-6", children: content.cards.workflows.description }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-4", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-foreground/30 uppercase tracking-wider", children: metric.label })
                    ] }, metric.label)) })
                  ] })
                ] }) }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$5, className: "col-span-12 sm:col-span-6 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BentoCard, { className: "h-full overflow-hidden", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 lg:p-8 -mt-6 relative z-10", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-12 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "h-5 w-5 text-amber-400" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-display text-foreground mb-2", children: content.cards.crm.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] text-foreground/40 leading-relaxed mb-4", children: content.cards.crm.description }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-semibold text-foreground", children: "31" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px] text-foreground/30", children: "contact fields" })
                    ] })
                  ] })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$5, className: "col-span-12 sm:col-span-6 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BentoCard, { className: "h-full p-6 lg:p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-display text-foreground mb-2", children: content.cards.marketing.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] text-foreground/40 leading-relaxed mb-4", children: content.cards.marketing.description }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto flex flex-wrap gap-2", children: ["Meta", "Google", "LinkedIn", "TikTok"].map((platform) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-1 text-[10px] text-foreground/40 bg-white/[0.03] rounded border border-white/[0.06]", children: platform }, platform)) })
                ] }) }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$5, className: "col-span-12 sm:col-span-6 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BentoCard, { className: "h-full p-6 lg:p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-display text-foreground mb-2", children: content.cards.multiTenant.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] text-foreground/40 leading-relaxed mb-4", children: content.cards.multiTenant.description }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto text-[12px] text-foreground/30", children: "650+ indexes • Workspace isolation" })
                ] }) }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$5, className: "col-span-12 sm:col-span-6 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BentoCard, { className: "h-full p-6 lg:p-8 group", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-display text-foreground mb-2", children: content.cards.security.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] text-foreground/40 leading-relaxed mb-4", children: content.cards.security.description }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$5, className: "mt-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  href: "#all-features",
...
function StatsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "metrics", className: "relative py-32 lg:py-40 bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-border to-transparent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-[1200px] px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        className: "relative",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants$4, className: "text-center mb-20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-semibold text-amber-400/80 uppercase tracking-[0.2em] mb-4", children: content.sectionLabel }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-[clamp(2rem,5vw,3rem)] font-display leading-[1.1] tracking-[-0.02em] text-foreground", children: [
              content.headline[0],
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12", children: content.stats.map((stat, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[clamp(2.5rem,6vw,4rem)] font-semibold tracking-tight text-foreground leading-none mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedNumber, { value: stat.value, suffix: stat.suffix }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[14px] font-medium text-foreground/60 mb-1", children: stat.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[12px] text-foreground/30", children: stat.description })
              ]
            },
            stat.label
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-3 px-5 py-3 rounded-full bg-muted/20 border border-white/[0.06]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex -space-x-2", children: [...Array(4)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-medium text-foreground/40", children: ["S", "M", "A", "J"][i] })
                  },
                  i
                )) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-4 w-px bg-white/10" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] text-foreground/40", children: content.socialProof })
              ] })
            }
          )
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-border to-transparent" })
  ] });
}
const tools = [
...
function PremiumSlider({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative pt-4 pb-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-white/[0.08]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 rounded-full bg-white shadow-lg shadow-amber-500/30 border-2 border-amber-400 transition-transform hover:scale-110", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-1 rounded-full bg-amber-400" }) })
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-8 left-0 text-[11px] text-foreground/40", children: formatValue(min) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-8 right-0 text-[11px] text-foreground/40", children: formatValue(max) })
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      className: cn(
        ...
        checked ? "border-amber-500/40 bg-amber-500/[0.08]" : "border-white/[0.06] bg-white/[0.02] hover:border-white/[0.1] hover:bg-white/[0.03]"
      ),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn(
          "flex items-center justify-center w-5 h-5 rounded-md border-2 transition-all duration-200",
          checked ? "border-amber-400 bg-amber-500" : "border-white/20 bg-transparent group-hover:border-white/30"
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 text-left", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-foreground/40", children: [
            "~$",
            tool.cost,
            "/mo"
          ] })
...
function SavingsCalculatorSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "calculator", className: "relative py-32 lg:py-40 bg-background overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-border to-transparent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[800px] rounded-full blur-[200px] opacity-[0.04] pointer-events-none glow-amber-soft" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ref,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants$3, className: "text-center mb-16", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/20 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator, { className: "h-4 w-4 text-amber-400" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold text-amber-400 uppercase tracking-wider", children: "ROI Calculator" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[clamp(2rem,5vw,3.5rem)] font-display leading-[1.1] tracking-[-0.02em] text-foreground mb-4", children: "See what you'll save." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-foreground/40 max-w-xl mx-auto", children: "Calculate your potential savings across agencies, employees, and tools." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$3, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-3xl border border-white/[0.08] bg-white/[0.02] overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pointer-events-none glow-amber-top-strong" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pointer-events-none opacity-[0.02] grid-pattern-sm" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col sm:flex-row gap-2 p-4 border-b border-white/[0.06]", children: tabs.map((tab) => {
                const Icon = tab.icon;
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    className: cn(
                      ...
                      isActive ? "bg-gradient-to-r from-amber-500/20 to-orange-500/20 text-foreground border border-amber-500/30" : "text-foreground/50 hover:text-foreground/70 hover:bg-white/[0.03]"
                    ),
                    children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-8 p-6 lg:p-10", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-foreground/50 mb-6", children: tabs.find((t) => t.id === activeTab)?.description }) }),
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center justify-between mb-4", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] font-medium text-foreground", children: "Monthly agency retainer" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[18px] font-semibold text-amber-400 tabular-nums", children: [
                                "$",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 rounded-xl bg-white/[0.02] border border-white/[0.06]", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-foreground/40 mb-3", children: "What you're paying for:" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-red-400/60 mt-1.5 shrink-0" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] text-foreground/50", children: item })
                            ] }, i)) })
                          ] })
                        ]
                      },
                    ...
                    activeTab === "employees" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      motion.div,
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 rounded-xl bg-amber-500/[0.08] border border-amber-500/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-5 h-5 text-amber-400 shrink-0 mt-0.5" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] font-medium text-amber-400 mb-1", children: "65% headcount reduction" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-foreground/50", children: "Run a 20-person agency with 7 people. AI handles the repetitive work—your team focuses on strategy and relationships." })
                            ] })
                          ] }) })
                        ]
                      },
                    ...
                    activeTab === "tools" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      motion.div,
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 rounded-xl bg-emerald-500/[0.08] border border-emerald-500/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-5 h-5 text-emerald-400 shrink-0 mt-0.5" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] font-medium text-emerald-400 mb-1", children: "OzziOS replaces all of these" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-foreground/50", children: "One platform, one login, one invoice. All the features you need." })
                            ] })
                          ] }) })
                        ]
                      },
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative p-8 rounded-2xl bg-gradient-to-br from-white/[0.04] to-white/[0.01] border border-white/[0.08] overflow-hidden", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-1/2 -translate-x-1/2 w-[300px] h-[200px] rounded-full blur-[100px] opacity-30 pointer-events-none glow-amber-subtle" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-foreground/40 uppercase tracking-wider mb-2", children: "Estimated Annual Savings" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[24px] text-foreground/50 ml-1", children: "/yr" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatePresence, { mode: "wait", children: [
                      activeTab === "agency" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        motion.div,
                        {
                          ...
                          className: "space-y-4",
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-3 border-t border-white/[0.06]", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] text-foreground/50", children: "Current annual spend" }),
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-3 border-t border-white/[0.06]", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] text-foreground/50", children: "OzziOS annual cost" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] font-medium text-emerald-400", children: "~$3,588" })
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-3 border-t border-white/[0.06]", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] text-foreground/50", children: "Savings percentage" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] font-semibold text-amber-400", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedValue, { value: agencySavings.percentage, suffix: "%" }) })
                            ] })
                          ]
                        },
                        "agency-results"
                      ...
                      activeTab === "employees" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        motion.div,
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-3 border-t border-white/[0.06]", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] text-foreground/50", children: "Current salary costs" }),
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-3 border-t border-white/[0.06]", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] text-foreground/50", children: "Team after AI (35%)" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[14px] font-medium text-emerald-400", children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedValue, { value: employeeSavings.employeesRemaining }),
                                " people"
                              ] })
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-3 border-t border-white/[0.06]", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] text-foreground/50", children: "Headcount reduction" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[14px] font-semibold text-amber-400", children: [
                                teamSize,
                                " → ",
                                /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedValue, { value: employeeSavings.employeesRemaining }),
                                " (65% less)"
                      ...
                      activeTab === "tools" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        motion.div,
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-3 border-t border-white/[0.06]", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] text-foreground/50", children: "Tools to cancel" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[14px] font-medium text-foreground", children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-3 border-t border-white/[0.06]", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] text-foreground/50", children: "Monthly savings" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[14px] font-medium text-emerald-400", children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-3 border-t border-white/[0.06]", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] text-foreground/50", children: "Fewer logins" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[14px] font-semibold text-amber-400", children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedValue, { value: toolSavings.count }),
                                " → 1"
                              ] })
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-[12px] text-foreground/30 mt-3", children: "Free trial • No credit card required" })
                    ] })
                  ] })
                ] }) }) })
              ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$3, className: "mt-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-foreground/30", children: "* Calculations are estimates based on industry averages. Your actual savings may vary." }) })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-border to-transparent" })
...
function FeaturesSection() {
  ...
  const ref = reactExports.useRef(null);
  const isInView = useInView(ref, { once: true, margin: "-100px" });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "how-it-works", className: "relative py-32 lg:py-40 bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-border to-transparent" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: content.steps.map((step, index) => {
            ...
            const colors = colorConfig$1[color];
              ...
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative lg:w-2/5 h-48 lg:h-auto min-h-[200px]", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn(
                      "absolute inset-0",
                      isEven ? "bg-gradient-to-r from-transparent via-transparent to-background" : "bg-gradient-to-l from-transparent via-transparent to-background",
                      "hidden lg:block"
                    ) }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 p-8 lg:p-10 flex flex-col justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] leading-relaxed text-foreground/40 mb-4", children: step.description }),
...
const channelAgents = [
  ...
  { name: "Data Analyst", role: "Performance Insights", icon: ChartNoAxesColumn, description: "Analytics deep-dives, ROI tracking, engagement metrics", variant: "tech" },
...
const executiveAgents = [
  ...
  { name: "Analytics Director", scope: "All clients", icon: ChartNoAxesColumn, description: "ROI comparison, trend analysis", variant: "tech" },
...
function AgentsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "agents", className: "relative py-32 lg:py-40 bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[400px] rounded-full blur-[150px] opacity-[0.04] pointer-events-none glow-indigo-soft"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 mb-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold text-indigo-400 uppercase tracking-wider", children: content.sectionLabel })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-[clamp(2rem,5vw,3.5rem)] font-display leading-[1.1] tracking-[-0.02em] text-foreground mb-6", children: [
              content.headline[0],
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "space-y-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold text-foreground/30 uppercase tracking-[0.15em]", children: "Channel Agents" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-white/[0.06]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-foreground/20", children: "10 agents" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative shrink-0", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn(
                          ...
                          isActive ? "bg-amber-500/20 text-amber-400" : "bg-background border border-border text-foreground/40"
                        ), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-3 w-3" }) })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[14px] font-medium text-foreground", children: agent.name }),
                          isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse" })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-foreground/30 mb-2", children: agent.role }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: cn(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold text-foreground/30 uppercase tracking-[0.15em]", children: "Executive Agents" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-white/[0.06]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-foreground/20", children: "4 agents" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
                  ...
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-4 inline-block", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn(
                          "absolute -bottom-1 -right-1 flex h-6 w-6 items-center justify-center rounded-lg transition-all duration-300",
                          isActive ? "bg-indigo-500/20 text-indigo-400" : "bg-background border border-border text-foreground/40"
                        ), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-3 w-3" }) })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[14px] font-medium text-foreground mb-1", children: agent.name }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-amber-400/70 mb-2", children: agent.scope }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-foreground/30", children: agent.description })
                    ]
                  },
                  agent.name
                );
          ...
          children: [
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-medium text-foreground/70", children: item.value }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] text-foreground/30 ml-2", children: item.label })
                ] })
              ]
            },
            item.label
...
const memoryLayers = [
  { id: "L1", name: "Brand Identity", color: "amber" },
  { id: "L2", name: "Business Rules", color: "rose" },
  { id: "L3", name: "Learnings", color: "violet" },
  { id: "L4", name: "Knowledge Base", color: "blue" },
  { id: "L5", name: "Error Patterns", color: "emerald" },
  { id: "L6", name: "Context", color: "cyan" }
];
const colorConfig = {
  amber: {
    bg: "bg-amber-500/10",
...
function MemorySection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "memory", className: "relative py-32 lg:py-40 bg-background overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] rounded-full blur-[150px] opacity-[0.03] pointer-events-none glow-amber-soft" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: "hidden",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "col-span-12 lg:col-span-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MemoryCard, { className: "h-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row h-full", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative lg:w-2/5 p-6 lg:p-8 bg-white/[0.01] border-b lg:border-b-0 lg:border-r border-white/[0.06]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: memoryLayers.map((layer, index) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("text-[10px] font-mono font-bold", colors.text), children: layer.id }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px] font-medium text-foreground/70", children: layer.name }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-[9px] text-foreground/30 uppercase tracking-wider", children: index < 4 ? "Stable" : "Dynamic" })
                    ]
                  },
                  layer.id
                );
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-8 lg:p-10 flex flex-col", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/20 mb-6 w-fit", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: "h-4 w-4 text-amber-400" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold text-amber-400 uppercase tracking-wider", children: "Memory Architecture" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl lg:text-3xl font-display text-foreground mb-3", children: "7 layers of context" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] text-foreground/40 leading-relaxed mb-6", children: "Your AI team maintains a structured memory system—from your brand identity down to real-time conversation context. Every interaction builds on what came before." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto grid grid-cols-3 gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "col-span-12 sm:col-span-6 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MemoryCard, { className: "h-full p-6 lg:p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-12 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCcw, { className: "h-5 w-5 text-emerald-400" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-display text-foreground mb-2", children: content.features[1].title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] text-foreground/40 leading-relaxed mb-4", children: content.features[1].description }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-2 rounded-full bg-emerald-400 animate-pulse" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px] text-emerald-400 font-medium", children: "Auto-learning enabled" })
              ] })
            ] }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "col-span-12 sm:col-span-6 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MemoryCard, { className: "h-full p-6 lg:p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-12 rounded-xl bg-violet-500/10 border border-violet-500/20 flex items-center justify-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "h-5 w-5 text-violet-400" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-display text-foreground mb-2", children: content.features[2].title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] text-foreground/40 leading-relaxed mb-4", children: content.features[2].description }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto flex flex-wrap gap-2", children: content.features[2].bullets.map((bullet) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: "px-2.5 py-1 text-[11px] font-medium text-foreground/40 bg-white/[0.03] rounded-md border border-white/[0.06]",
                  children: bullet
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "col-span-12 lg:col-span-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MemoryCard, { className: "h-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row-reverse h-full", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative lg:w-2/5 p-8 bg-white/[0.01] border-b lg:border-b-0 lg:border-l border-white/[0.06] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[64px] font-bold text-foreground/10 leading-none mb-2", children: "0%" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[13px] text-foreground/40 uppercase tracking-wider", children: "Knowledge Loss" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-8 lg:p-10", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-12 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-5 w-5 text-blue-400" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-display text-foreground mb-3", children: content.features[3].title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] text-foreground/40 leading-relaxed mb-6", children: content.features[3].description }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-4", children: content.features[3].bullets.map((benefit) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    className: "inline-flex items-center gap-1.5 text-[12px] text-foreground/40",
                    children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "col-span-12 sm:col-span-6 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MemoryCard, { className: "h-full p-6 lg:p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-12 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Brain, { className: "h-5 w-5 text-amber-400" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-display text-foreground mb-2", children: content.features[0].title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] text-foreground/40 leading-relaxed mb-4", children: content.features[0].description }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-semibold text-foreground", children: "100%" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px] text-foreground/30", children: "brand consistency" })
              ] }) })
            ] }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "col-span-12 sm:col-span-6 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MemoryCard, { className: "h-full p-6 lg:p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-12 rounded-xl bg-rose-500/10 border border-rose-500/20 flex items-center justify-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(History, { className: "h-5 w-5 text-rose-400" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-display text-foreground mb-2", children: content.comparisonTitle }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] text-foreground/40 leading-relaxed mb-4", children: content.comparisonDescription }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto grid grid-cols-2 gap-4", children: content.comparisonStats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl font-semibold text-foreground", children: stat.value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-foreground/30 uppercase tracking-wider", children: stat.label })
              ] }, stat.label)) })
            ] }) }) })
          ] })
        ]
...
function MemoryCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pointer-events-none opacity-50 bg-gradient-to-b from-foreground/[0.02] to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10", children })
      ]
    }
  );
...
function PricingSection() {
  const ref = reactExports.useRef(null);
  const isInView = useInView(ref, { once: true, margin: "-100px" });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "pricing", className: "relative py-32 lg:py-40 bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-border to-transparent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] rounded-full blur-[120px] opacity-10 pointer-events-none glow-amber-hero"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-semibold text-amber-400/80 uppercase tracking-[0.2em] mb-4", children: "Pricing" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-[clamp(2rem,5vw,3rem)] font-display leading-[1.1] tracking-[-0.02em] text-foreground mb-6", children: [
              "Stop overpaying for",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/30", children: " agencies" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg text-foreground/40 max-w-2xl mx-auto mb-4", children: [
              "You're paying $5,000/month for an agency that takes 3 days to respond.",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/60", children: " Ozzi runs 24/7 for a fraction of the cost." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] text-amber-400/70", children: "Save 50-80% compared to traditional agency retainers" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 lg:grid-cols-3", children: pricingTiers.map((tier, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 30 },
          animate: isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 },
          ...
          className: cn(
            ...
            tier.popular ? "border-amber-500/30 bg-gradient-to-b from-amber-500/[0.08] to-transparent scale-[1.02] lg:scale-105" : "border-white/[0.08] bg-white/[0.02] hover:border-white/[0.15] hover:bg-white/[0.04]"
          ),
          children: [
            tier.popular && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-4 left-1/2 -translate-x-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-amber-500 text-[#0A0A0B]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-3.5 h-3.5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold uppercase tracking-wider", children: "Most Popular" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold text-foreground mb-1", children: tier.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-amber-400/70", children: tier.tagline })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[42px] font-display tracking-tight text-foreground", children: [
                  "$",
                  tier.price.toLocaleString()
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[15px] text-foreground/40", children: "/month" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-foreground/40 mt-2", children: tier.description })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: tier.href,
                className: cn(
                  "flex items-center justify-center gap-2 w-full h-12 rounded-xl font-medium text-[14px] transition-all duration-300 mb-8",
                  tier.popular ? "bg-white text-[#0A0A0B] hover:bg-white/90" : "bg-white/[0.08] text-foreground hover:bg-white/[0.12] border border-white/[0.08]"
                ),
                children: [
                  tier.cta,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: tier.features.map((feature, featureIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn(
                ...
                feature.includes("Everything in") ? "bg-transparent" : tier.popular ? "bg-amber-500/20" : "bg-white/[0.08]"
              ), children: !feature.includes("Everything in") && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: cn(
                "w-3 h-3",
                tier.popular ? "text-amber-400" : "text-foreground/50"
              ) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn(
                "text-[13px] leading-relaxed",
                feature.includes("Everything in") ? "text-foreground/60 font-medium" : "text-foreground/50"
              ), children: feature })
            ] }, featureIndex)) })
          ]
        },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] text-foreground/40", children: "All plans include a 14-day free trial. No credit card required." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[13px] text-foreground/30 mt-2", children: [
              "Need a custom plan for your enterprise? ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:sales@ozzios.com", className: "text-amber-400 hover:text-amber-300 transition-colors", children: "Contact sales" })
            ] })
          ]
        }
      )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-foreground/40 max-w-lg mx-auto", children: content.subheadline })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: content.items.map((testimonial, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[15px] leading-relaxed text-foreground/50 mb-8", children: [
                      '"',
                      testimonial.content,
                      '"'
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mt-auto", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] font-medium text-foreground", children: testimonial.name }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[12px] text-foreground/30", children: [
                          testimonial.role,
                          " ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: content.trustStats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-semibold text-foreground mb-1", children: stat.value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[12px] text-foreground/30 uppercase tracking-wider", children: stat.label })
              ] }, stat.label))
            }
          )
        ] })
...
function FAQSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "faq", className: "relative py-32 lg:py-40 bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-border to-transparent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto max-w-[900px] px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-[clamp(2rem,5vw,3rem)] font-display leading-[1.1] tracking-[-0.02em] text-foreground mb-6", children: [
              "Frequently asked",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/30", children: " questions" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-foreground/40 max-w-lg mx-auto", children: "Everything you need to know about OzziOS." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "mt-16 text-center",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] text-foreground/40 mb-4", children: "Still have questions?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: cn(
        ...
        isOpen ? "border-border bg-muted/20" : "border-border bg-transparent hover:border-border/80"
      ),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[15px] font-medium text-foreground", children: question }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn(
                "shrink-0 w-8 h-8 rounded-lg flex items-center justify-center transition-colors",
                isOpen ? "bg-amber-500/10" : "bg-white/[0.04]"
              ), children: isOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "h-4 w-4 text-amber-400" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-4 w-4 text-foreground/40" }) })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { initial: false, children: isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 sm:px-6 pb-5 sm:pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] leading-relaxed text-foreground/40", children: answer }) })
          }
        ) })
      ]
    }
...
function CTASection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-32 lg:py-40 bg-[#0A0A0B] overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-border to-transparent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[600px] rounded-full blur-[150px] opacity-[0.06] pointer-events-none glow-amber-soft" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        transition: { duration: 0.7 },
        className: "relative",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-3xl border border-border bg-card/50 overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pointer-events-none glow-amber-top-cta" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pointer-events-none opacity-[0.03] grid-pattern-lg" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold text-amber-400 uppercase tracking-wider", children: content.badge })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.h2,
              {
                ...
                children: [
                  content.headline[0],
                  /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-gradient-to-r from-amber-200 via-orange-300 to-amber-200 bg-clip-text text-transparent", children: content.headline[1] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#contact", children: content.secondaryButton })
                    }
                  )
                ]
              }
...
function LandingHomeView() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SavingsCalculatorSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FeaturesSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AgentsSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MemorySection, {}),
