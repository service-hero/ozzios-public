...
import { u as useAudience, U as Users, A as AnimatePresence } from "./LandingLayout-BbzH_Y3t.js";
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "text-center mb-16 lg:mb-20 max-w-3xl mx-auto", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground leading-relaxed font-light", children: "Calculate your potential savings across outsourcing, employees, and tools." })
        ] }),
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center justify-between mb-4", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] font-medium text-foreground", children: "Monthly outsourced spend" }),
