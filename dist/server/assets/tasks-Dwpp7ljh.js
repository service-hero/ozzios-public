...
import { U as Users, d as Bot, L as LandingLayout } from "./LandingLayout-BbzH_Y3t.js";
...
import { R as Repeat } from "./repeat-C_D1rCm3.js";
import { L as LayoutGrid } from "./layout-grid-CoVSn2s5.js";
import { G as GitBranch } from "./git-branch-B7FJU1vD.js";
import { C as CalendarClock } from "./calendar-clock-DhVYzFga.js";
import { T as Tag } from "./tag-BzS4WMmw.js";
...
const capabilities = [
  ...
  },
  {
    ...
    description: "Set tasks to repeat daily, weekly, or monthly. Customer follow-ups, equipment inspections, service reminders -- create once, run forever."
  },
  {
    icon: Bot,
  ...
  },
  {
    ...
    description: "Save reusable task templates for new jobs, onboarding, and inspections. Tag and filter to find anything in seconds."
  }
];
const workflowSteps = [
  {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl text-foreground tracking-tight mb-4", children: "Your task management is costing you customers" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Service businesses lose an average of 12% of revenue to missed appointments and poor coordination. Here is why." })
        ]
      }
    ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Built for service companies that juggle dozens of customers and hundreds of jobs." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
