...
import { a7 as Bot, a0 as Layers, U as Users, aI as Workflow, a5 as Briefcase, aw as Megaphone, x as ChartColumn, S as Shield, p as ArrowUpRight } from "./vendor-icons-BFmuwI-v.js";
      ...
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-4 lg:gap-5", style: { gridAutoFlow: "dense" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "col-span-12 sm:col-span-6 lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BentoCard, { className: "h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full flex-col p-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(BentoIcon, { Icon: Shield }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-5 text-[17px] font-semibold leading-tight text-foreground", children: content.cards.security.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-[13px] leading-[1.55] text-muted-foreground", children: content.cards.security.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto pt-5 inline-flex items-center gap-2 self-start rounded-[5px] border border-signature/25 bg-signature/10 px-2 py-0.5 font-mono text-[9.5px] font-semibold uppercase tracking-wider text-signature", children: [
