    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl font-light leading-relaxed", children: "Stop overpaying for outsourced services. Get enterprise-level automation at a fraction of the cost." })
        ]
      }
    ),
