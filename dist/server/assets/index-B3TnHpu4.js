...
import { u as useAudience, a as audienceContent, L as LandingLayout } from "./LandingLayout-B-c7Elxf.js";
import { B as Button } from "./button-HnwzKl7C.js";
import { c as cn } from "./utils-QXBWQHlM.js";
import { A as ArrowRight, o as Play, e as ChevronDown, p as Star, q as Hash, r as Menu, f as Search, s as Settings, h as MessageSquare, C as CircleCheck, t as FileText, u as StickyNote, j as Sparkles, g as Send, X } from "./vendor-icons-BkkOHNOi.js";
...
const BentoSection = reactExports.lazy(
  () => import("./BentoSection-oLhx-geY.js").then((m) => ({ default: m.BentoSection }))
);
const FeaturesShowcaseSection = reactExports.lazy(
  () => import("./FeaturesShowcaseSection-DcF0Fnmw.js").then((m) => ({
    default: m.FeaturesShowcaseSection
  }))
);
const SavingsCalculatorSection = reactExports.lazy(
  () => import("./SavingsCalculatorSection-BgLEN7ze.js").then((m) => ({
    default: m.SavingsCalculatorSection
  }))
);
const FeaturesSection = reactExports.lazy(
  () => import("./HowItWorksSection-BNeP3Wrv.js").then((m) => ({ default: m.FeaturesSection }))
);
const AgentsSection = reactExports.lazy(
  () => import("./AgentsSection-D_IU7Enm.js").then((m) => ({ default: m.AgentsSection }))
);
const MemorySection = reactExports.lazy(
  () => import("./MemorySection-C3-qCglM.js").then((m) => ({ default: m.MemorySection }))
);
const PricingSection = reactExports.lazy(
  () => import("./PricingSection-D0Q3biUQ.js").then((m) => ({ default: m.PricingSection }))
);
const IntegrationsSection = reactExports.lazy(
  () => import("./IntegrationsSection--IP9IrKs.js").then((m) => ({
    default: m.IntegrationsSection
  }))
);
const TestimonialsSection = reactExports.lazy(
  () => import("./TestimonialsSection-BkRtbG2R.js").then((m) => ({
    default: m.TestimonialsSection
  }))
);
const FAQSection = reactExports.lazy(
  () => import("./FAQSection-CwV7UJon.js").then((m) => ({ default: m.FAQSection }))
);
const CTASection = reactExports.lazy(
  () => import("./CTASection-B-pwKJ34.js").then((m) => ({ default: m.CTASection }))
);
