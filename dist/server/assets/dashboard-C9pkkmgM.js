...
import { i as LayoutDashboard, g as Palette, d as Bot, L as LandingLayout } from "./LandingLayout-BbzH_Y3t.js";
...
import { S as Save } from "./save-DXwyNkcG.js";
import { A as Activity } from "./activity-DAKfNN_X.js";
import { G as Gauge } from "./gauge-B12CnzM-.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative pt-32 pb-16 lg:pt-40 lg:pb-20 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: "hidden", animate: "visible", variants: containerVariants, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "text-center mb-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10", children: "A customizable, real-time dashboard with 18 widget types that puts your entire operation -- AI agents, customers, campaigns, and tasks -- in one view." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Your dashboard is the front door. Behind it is a full platform -- inbox, search, notifications, and knowledge base." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-24 lg:py-32 bg-muted/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-4xl px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground mb-10 max-w-lg mx-auto", children: "One dashboard for your AI agents, customers, campaigns, and operations. Customizable, real-time, and built for the way you work." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: "https://app.ozzios.com/sign-up",
