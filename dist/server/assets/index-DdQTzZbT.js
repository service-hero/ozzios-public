...
import { u as useAudience, b as audienceContent, A as AnimatePresence, C as ChevronDown, c as Menu, a as MessageSquare, F as FileText, X, L as LandingLayout } from "./LandingLayout-CWo80zJB.js";
...
import { S as Star, a as Settings } from "./star-DPW1tum4.js";
import { H as Hash } from "./hash-D6SM1fZh.js";
...
const BentoSection = reactExports.lazy(
  () => import("./BentoSection-B-Iq_i_v.js").then((m) => ({ default: m.BentoSection }))
);
const ComparisonSection = reactExports.lazy(
  () => import("./ComparisonSection-DC_RCFhS.js").then((m) => ({ default: m.ComparisonSection }))
);
const FeaturesShowcaseSection = reactExports.lazy(
  () => import("./FeaturesShowcaseSection-DIlXnTLa.js").then((m) => ({
    default: m.FeaturesShowcaseSection
  }))
);
const SavingsCalculatorSection = reactExports.lazy(
  () => import("./SavingsCalculatorSection-Dv_V3K1A.js").then((m) => ({
    default: m.SavingsCalculatorSection
  }))
);
const FeaturesSection = reactExports.lazy(
  () => import("./HowItWorksSection-BZvrjdVx.js").then((m) => ({ default: m.FeaturesSection }))
);
const AgentsSection = reactExports.lazy(
  () => import("./AgentsSection-CCyLmqzO.js").then((m) => ({ default: m.AgentsSection }))
);
const MemorySection = reactExports.lazy(
  () => import("./MemorySection-V2nr5DWx.js").then((m) => ({ default: m.MemorySection }))
);
const PricingSection = reactExports.lazy(
  () => import("./PricingSection-Blhjc05R.js").then((m) => ({ default: m.PricingSection }))
);
const IntegrationsSection = reactExports.lazy(
  () => import("./IntegrationsSection-DEkj6VtI.js").then((m) => ({
    default: m.IntegrationsSection
  }))
);
const TestimonialsSection = reactExports.lazy(
  () => import("./TestimonialsSection-BPryyxBR.js").then((m) => ({
    default: m.TestimonialsSection
  }))
);
const FAQSection = reactExports.lazy(
  () => import("./FAQSection-D5IQsoUn.js").then((m) => ({ default: m.FAQSection }))
);
const CTASection = reactExports.lazy(
  () => import("./CTASection-CH-LOMox.js").then((m) => ({ default: m.CTASection }))
);
