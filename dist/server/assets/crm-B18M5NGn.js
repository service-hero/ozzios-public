...
import { F as FeatureHero, P as PainPointsBlock, C as CapabilitiesBlock, e as ChecklistBlock, a as FeatureCTABlock, S as SectionHeader, c as SectionHeading } from "./_landing-primitives-BgwWv7GL.js";
import { U as Users, v as FileText, _ as TrendingUp, S as Shield, n as Brain, aU as Activity, j as Sparkles, aZ as Funnel, au as Tag, A as ArrowRight, M as Mail, h as MessageSquare, z as Phone } from "./vendor-icons-BFmuwI-v.js";
...
const painPoints = [
  ...
  },
  {
    ...
    description: "Sales says they called. Marketing says they emailed. Support says they filed a ticket. Nobody has the full picture because the data lives in 5 different tools."
  },
  {
    icon: TrendingUp,
    title: "Lead scoring is a guess",
    description: 'Your team assigns "hot" and "cold" labels based on gut feel. There is no system, no consistency, and no way to know which leads actually deserve attention.'
  },
  {
    icon: Shield,
    title: "Compliance is an afterthought",
    description: "GDPR requires consent tracking. You're storing it in a spreadsheet. Or not at all. One audit could cost you more than your entire annual revenue."
  }
];
const capabilities = [
  {
    ...
    description: "Three AI-computed scores — lead, engagement, and close probability — updated automatically. Stop guessing and start closing."
  },
  {
    icon: Activity,
    title: "25+ activity types",
    benefit: "The complete picture, always",
    description: "Every email, call, meeting, form submission, and document signing tracked on a unified timeline. Know exactly what happened, when."
  },
  {
    icon: Sparkles,
    title: "Contact enrichment",
    benefit: "Fill in the blanks automatically",
    description: "Apollo.io integration enriches contacts with B2B data — company, title, revenue, tech stack. Single or bulk with one click."
  },
  {
    icon: Funnel,
  ...
  },
  {
    ...
    description: "Text, number, date, select, checkbox fields organized in folders. Plus workspace-scoped tags for flexible categorization."
  },
  {
    icon: Shield,
...
const lifecycleStages = [
  { stage: "Subscriber", description: "Opted in but not yet engaged", tone: "neutral" },
  { stage: "Lead", description: "Showing interest and activity", tone: "electric" },
  { stage: "Opportunity", description: "Qualified and in your pipeline", tone: "signature" },
  { stage: "Customer", description: "Closed and generating revenue", tone: "mint" },
  { stage: "Evangelist", description: "Referring and advocating", tone: "signature" }
];
const activityTypes = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative isolate overflow-hidden border-t border-border/50 py-24 lg:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto max-w-[1480px] px-4 sm:px-6 lg:px-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid items-center gap-12 lg:grid-cols-2 lg:gap-16", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-xl border border-border/60 bg-background", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border/60 bg-muted/30 px-5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { label: "Pipeline stages" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border/60", children: lifecycleStages.map((stage, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                      className: cn(
                        ...
                        stage.tone === "signature" ? "border-signature/30 bg-signature/10 text-signature" : stage.tone === "mint" ? "border-mint/30 bg-mint/10 text-mint" : stage.tone === "electric" ? "border-foreground/15 bg-foreground/5 text-foreground/80" : "border-border/60 bg-background text-foreground/55"
                      ),
                      children: [
                        "0",
                        i + 1
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[13.5px] font-semibold text-foreground", children: stage.stage }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] leading-[1.5] text-muted-foreground", children: stage.description })
                  ] }),
                  i < lifecycleStages.length - 1 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-3.5 w-3.5 shrink-0 text-foreground/30" }) : null
                ]
              },
              stage.stage
            )) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 overflow-hidden rounded-xl border border-border/60 bg-background/60 backdrop-blur", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border/60 bg-muted/30 px-5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { label: "Tracked activity types" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 divide-x divide-y divide-border/60", children: activityTypes.map((type, i) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-3.5 w-3.5 shrink-0 text-signature" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11.5px] font-semibold text-foreground", children: type.label }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[9px] uppercase tracking-wider text-muted-foreground", children: type.count })
                    ] })
                  ]
                },
                type.label
...
function CRMView() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DeferredSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(LifecycleSection, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DeferredSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      CapabilitiesBlock,
      {
