...
import { U as Users, B as Brain, L as LandingLayout } from "./LandingLayout-BbzH_Y3t.js";
import { m as motion, A as ArrowRight } from "./proxy-wI6KZf5t.js";
import { B as Building2 } from "./building-2-rusPyv4Q.js";
...
import { G as GitBranch } from "./git-branch-B7FJU1vD.js";
import { E as Eye } from "./eye-D9avLgDr.js";
import { T as Target } from "./target-BMh56x6_.js";
import { L as Lock } from "./lock-Bta4kdvH.js";
import { F as FileCheck } from "./file-check-XoYZTIgD.js";
...
const painPoints = [
  ...
  },
  {
    ...
    description: "Different team members, different processes, different quality levels. Your enterprise customers expect uniform excellence. You struggle to deliver it at scale."
  },
  {
    icon: Shield,
    title: "Security and compliance are non-negotiable",
    description: "Your enterprise customers require strict security, GDPR compliance, and data isolation. One breach could end relationships worth millions in annual revenue."
  }
];
const features = [
  {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative pt-32 pb-16 lg:pt-40 lg:pb-20 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: "hidden", animate: "visible", variants: containerVariants, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "tag-neo rounded-full text-signature bg-signature/10 border-signature mb-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold uppercase tracking-wider ml-1.5", children: "For Enterprise Service Companies" })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10", children: "You manage dozens of service areas, each expecting white-glove service. OzziOS gives you the infrastructure to deliver enterprise-grade operations at scale -- with AI doing the heavy lifting across every location." }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-24 lg:py-32 bg-muted/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-4xl px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground mb-10 max-w-lg mx-auto", children: "See how OzziOS can transform your service company operations. Get a personalized demo from our enterprise team." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
