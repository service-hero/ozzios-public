...
const $$splitComponentImporter$8 = () => import("./waitlist-business-0eUFuW1u.js");
const Route$8 = createFileRoute("/waitlist-business")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./waitlist-DYVgf3fh.js");
const Route$7 = createFileRoute("/waitlist")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./tos-_1tnDTPS.js");
const Route$6 = createFileRoute("/tos")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./privacy-policy-0n5EgmL6.js");
const Route$5 = createFileRoute("/privacy-policy")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./blog-CpaZAEnB.js");
const Route$4 = createFileRoute("/blog")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./index-Cdvk6UPt.js");
const Route$3 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./blog.index-CrTUiO67.js");
const Route$2 = createFileRoute("/blog/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./_-CLq-GoUf.js");
const Route$1 = createFileRoute("/docs/$")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./blog._postId-DRw6OmTu.js");
const Route2 = createFileRoute("/blog/$postId")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const WaitlistBusinessRoute = Route$8.update({
  id: "/waitlist-business",
  path: "/waitlist-business",
  getParentRoute: () => Route$9
});
const WaitlistRoute = Route$7.update({
  id: "/waitlist",
  path: "/waitlist",
  getParentRoute: () => Route$9
});
const TosRoute = Route$6.update({
  id: "/tos",
  path: "/tos",
  getParentRoute: () => Route$9
});
