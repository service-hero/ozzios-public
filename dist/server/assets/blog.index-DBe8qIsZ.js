...
import { f as Search, T as TrendingUp, c as Clock, A as ArrowRight } from "./vendor-icons-BkkOHNOi.js";
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "text-center mb-16", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-display font-display text-foreground mb-6", children: [
                "Insights for the",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-signature", children: "AI-first service business" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Strategies, case studies, and product updates to help you build a service business that scales without the headcount." })
            ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-24 bg-muted/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-[600px] px-6 lg:px-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] text-muted-foreground mb-8", children: "Weekly strategies for building an AI-first service business. No spam, unsubscribe anytime." }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-[12px] text-muted-foreground", children: "Join 2,000+ service business owners already subscribed" })
        ]
      }
    ) }) })
  ] });
