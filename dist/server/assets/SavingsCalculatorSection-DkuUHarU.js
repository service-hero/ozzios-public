...
import { u as useAudience } from "./LandingLayout-CPC6VFbg.js";
import { J as Building2, U as Users, N as Layers, j as Sparkles, A as ArrowRight, a as Check } from "./vendor-icons-RMyvaHp0.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-9 w-9 items-center justify-center rounded-2xl bg-foreground/[0.05] font-mono text-[0.7rem] font-semibold tracking-[0.14em] text-foreground/68", children: tool.icon }),
...
function SavingsCalculatorSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "calculator", className: "relative overflow-hidden py-32 lg:py-40", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-x-0 top-20 h-80 bg-[radial-gradient(circle_at_top,rgba(196,88,63,0.1),transparent_58%)] blur-3xl" }),
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "mb-16 max-w-5xl lg:mb-20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-6 text-[0.72rem] font-medium uppercase tracking-[0.26em] text-foreground/45", children: "ROI calculator" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-6 text-[clamp(3rem,5.2vw,5.2rem)] font-display font-medium tracking-[-0.06em] text-foreground leading-[0.92]", children: "See what you'll save." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-2xl text-lg leading-8 text-muted-foreground", children: "Calculate your potential savings across marketing services, employees, and tools." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-[2rem] border border-white/80 bg-white/80 shadow-[0_24px_70px_rgba(56,40,29,0.08)] ring-1 ring-black/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2 border-b border-border/60 bg-[rgba(247,241,235,0.88)] p-4 sm:flex-row", children: tabs.map((tab) => {
              const Icon = tab.icon;
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: cn(
                    ...
                    isActive ? "border border-white/80 bg-white text-foreground shadow-[0_12px_30px_rgba(56,40,29,0.08)]" : "text-muted-foreground hover:bg-white/50 hover:text-foreground/80"
                  ),
                  children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-8 p-6 lg:grid-cols-2 lg:gap-10 lg:p-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 rounded-[1.75rem] border border-white/80 bg-[rgba(255,255,255,0.52)] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.85)] lg:p-8", children: [
                  ...
                  activeTab === "agency" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    motion.div,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-[1.4rem] border border-border/60 bg-[rgba(247,241,235,0.9)] p-4", children: [
                  ...
                  activeTab === "tools" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    motion.div,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-[1.4rem] border border-emerald-200 bg-emerald-50/90 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-[1.75rem] border border-white/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.88),rgba(244,238,232,0.98))] p-8 shadow-[0_20px_60px_rgba(56,40,29,0.08)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
