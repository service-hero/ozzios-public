...
import { A as AnimatedBackground } from "./index-Cx4p0SSa.js";
import { g as Send, h as MessageSquare, W as Share2, M as Mail, ba as FileInput, aP as Code, aB as BookOpen, aO as SquareCheckBig, U as Users, aL as LayoutDashboard, a0 as Bot, ac as Phone, aK as Workflow, ay as MessageCircle, aM as MessageSquareText, A as ArrowRight, t as FileText } from "./vendor-icons-RMyvaHp0.js";
import "./vendor-react-MO5I_vdy.js";
import "./vendor-radix-Bd9PM-r6.js";
import "node:async_hooks";
import "./LandingLayout-CPC6VFbg.js";
import "./lazy-section-B65XiZaR.js";
const categories = [
...
function FeaturesShowcaseSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "showcase", className: "relative overflow-hidden py-32 lg:py-40", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedBackground, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto max-w-[1440px] px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: "hidden",
        whileInView: "visible",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "mb-16 max-w-5xl lg:mb-20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-6 text-[0.72rem] font-medium uppercase tracking-[0.26em] text-foreground/45", children: "Platform capabilities" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "max-w-5xl text-[clamp(3rem,5.6vw,5.8rem)] font-display font-medium leading-[0.92] tracking-[-0.06em] text-foreground mb-6", children: [
              "Everything your team needs.",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground/78", children: "One unified system." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-2xl text-lg leading-8 text-muted-foreground", children: "17 product surfaces replacing the patchwork stack most service businesses bolt together." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "scrollbar-hide -mx-1 flex gap-2 overflow-x-auto px-1 pb-2", children: categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => setActiveCategory(cat.id),
              className: cn(
                "whitespace-nowrap rounded-full px-4 py-2.5 text-sm font-medium transition-all duration-200",
                activeCategory === cat.id ? "bg-foreground text-background" : "border border-border bg-white/70 text-muted-foreground hover:border-foreground/20 hover:text-foreground"
              ),
              children: cat.label
            },
            cat.id
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "mt-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: "14 features" }),
            " across 4 categories.",
            " ",
