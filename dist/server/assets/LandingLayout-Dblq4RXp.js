...
import { aa as Bot, aK as Workflow, U as Users, aL as LayoutDashboard, M as MessageSquare, l as Mail, J as Smartphone, N as Phone, aM as MessageSquareText, aN as Palette, a6 as Share2, T as ClipboardList, aO as SquareCheckBig, aP as Code, p as Brain, aC as BookOpen, y as FileText, f as Sparkles, r as ArrowUpRight, t as ChevronDown, X, w as Menu, aQ as CornerDownLeft, A as ArrowRight, L as Lock, aR as MapPin, G as Globe } from "./vendor-icons-D94uOSxG.js";
...
const DEMO_CTA_HREF = "demo:book";
const CAL_NAMESPACE = "secret";
const CAL_LINK = "ozzios/secret";
const CAL_CONFIG = JSON.stringify({
  layout: "month_view",
  useSlotsViewOnSmallScreen: "true"
});
const bookDemoTriggerProps = {
  "data-cal-namespace": CAL_NAMESPACE,
  "data-cal-link": CAL_LINK,
  "data-cal-config": CAL_CONFIG
};
function isDemoCta(href) {
  return href === DEMO_CTA_HREF;
}
function useCalDemoInit() {
  reactExports.useEffect(() => {
    let cancelled = false;
    (async () => {
      const cal = await j({ namespace: CAL_NAMESPACE });
      if (cancelled) return;
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        ...
                        "Setup a demo",
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Kbd, { tone: "dark", className: "h-[18px]", children: "D" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mt-20 select-none lg:mt-28", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none flex justify-center overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          ...
          style: {
            ...
            maskImage: "linear-gradient(180deg, rgba(0,0,0,1) 0%, rgba(0,0,0,0.95) 22%, rgba(0,0,0,0.65) 50%, rgba(0,0,0,0.25) 75%, rgba(0,0,0,0) 92%)",
            WebkitMaskImage: "linear-gradient(180deg, rgba(0,0,0,1) 0%, rgba(0,0,0,0.95) 22%, rgba(0,0,0,0.65) 50%, rgba(0,0,0,0.25) 75%, rgba(0,0,0,0) 92%)"
          }
        }
      ) }) }),
