import { a as reactExports, n as jsxRuntimeExports, q as requireShim, s as commonjsGlobal } from "./worker-entry-DIC8UpJI.js";
import { u as useAudience, b as audienceContent, A as AnimatePresence, C as ChevronDown, a as MessageSquare, F as FileText, c as Bot, U as Users, W as Workflow, d as Code, S as Share2, M as Mail, e as Monitor, f as SquareCheckBig, g as LayoutDashboard, P as Phone, h as MessageSquareText, i as Palette, B as Brain, L as LandingLayout } from "./LandingLayout-_Rk3zA7h.js";
import { c as createSlot, B as Button } from "./button-Cce7Ah0G.js";
import { L as Link } from "./router-kXCOQ41n.js";
import { c as cn } from "./utils-QXBWQHlM.js";
import { a as animateVisualElement, s as setTarget, u as useConstant, b as useIsomorphicLayoutEffect$1, m as motion, A as ArrowRight } from "./proxy-CBHrjLyJ.js";
import { P as Play } from "./play-nqB5zhD0.js";
import { S as Star, a as Settings } from "./star-eqFJk17z.js";
import { H as Hash } from "./hash-CRBlaKfE.js";
import { M as Menu, B as BookOpen } from "./menu-2JpqeIYT.js";
import { S as Search } from "./search-Bo0psj8l.js";
...
import { S as Send } from "./send-Bz5_XzNq.js";
import { L as Layers } from "./layers-B2mDf9MR.js";
import { B as Briefcase } from "./briefcase-ckK-gQwP.js";
import { M as Megaphone } from "./megaphone-CEC50sLa.js";
import { C as ChartColumn } from "./chart-column-BcZPCg7J.js";
import { S as Shield } from "./shield-CNL1vjWD.js";
import { W as Wrench } from "./wrench-DR2DdodR.js";
import { S as Server } from "./server-CK6YhCd0.js";
import { C as Clock } from "./clock-C4zHZISm.js";
import { F as FileCheck } from "./file-check-CiMvnBEA.js";
import { M as MessageCircle } from "./message-circle-kPwT9kmt.js";
import { u as useInView } from "./use-in-view-Cg991X_n.js";
import { B as Building2 } from "./building-2-B8y-wKpb.js";
import { C as Check } from "./check-D6Pf0RHH.js";
import { R as Rocket } from "./rocket-DK8ajaHW.js";
import { T as TrendingUp } from "./trending-up-DIdDH_99.js";
import { P as PenTool } from "./pen-tool-DQAslVlT.js";
import { T as Target } from "./target-D4LzDxP4.js";
import { V as Video } from "./video-ByVreN2h.js";
import { Z as Zap } from "./zap-D4CMEOVU.js";
import { H as History } from "./history-FgQtcU4Y.js";
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 w-full mx-auto max-w-[1400px] px-6 lg:px-8 pt-32 pb-20 lg:pt-40 lg:pb-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$7, className: "mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-muted/30 border border-border/50", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$7, className: "mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "https://app.ozzios.com/sign-up?plan=solo", children: [
                          "Start free trial",
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-6xl px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants$6, className: "mb-20 max-w-3xl", children: [
...
function ComparisonSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "comparison", className: "py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants$5, className: "text-center mb-16 lg:mb-24 max-w-3xl mx-auto", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "showcase", className: "relative py-24 lg:py-32 bg-muted/30 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto max-w-7xl px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants$4, className: "mb-16 lg:mb-20 max-w-3xl", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-px bg-signature" }),
...
function SavingsCalculatorSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "calculator", className: "py-24 lg:py-32 bg-muted/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-[1200px] px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants$3, className: "text-center mb-16 lg:mb-20 max-w-3xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-px bg-signature" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground leading-relaxed font-light", children: "Calculate your potential savings across agencies, employees, and tools." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants$3, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-border/80 bg-card overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] ring-1 ring-black/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-8 p-6 lg:p-10", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 rounded-2xl bg-muted/50 border border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-[11px] text-muted-foreground mt-4", children: "7-day free trial • Cancel anytime" })
              ] })
            ] }) }) }) })
          ] })
        ] }) }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl font-light leading-relaxed", children: "Stop overpaying for agencies. Get enterprise-level marketing automation at a fraction of the cost." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-start", children: pricingTiers.map((tier, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-foreground", children: tier.name }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: tier.credits })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2.5 mb-6", children: tier.features.map((feature, featureIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-muted-foreground shrink-0 mt-0.5" }),
...
function IntegrationsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-24 lg:py-32 bg-background overflow-hidden border-t border-border/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6 lg:px-8 z-10", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "relative w-full max-w-5xl mx-auto aspect-square md:aspect-[16/9] mt-12 md:mt-24", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute z-20 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, scale: 0.5 },
          animate: isInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.5 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-signature/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-10 h-10 md:w-12 md:h-12 text-signature transform group-hover:scale-110 transition-transform duration-500" })
          ]
        }
      ) })
    ] })
...
function LandingHomeView() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(IntegrationsSection, {}),
