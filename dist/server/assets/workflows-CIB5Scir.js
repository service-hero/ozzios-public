...
import { M as Mail, L as LandingLayout } from "./LandingLayout-CWwQi4iJ.js";
...
import { M as MousePointerClick } from "./mouse-pointer-click-DiEru2UL.js";
...
import { R as Repeat } from "./repeat-DJqBuV6X.js";
import { W as Webhook } from "./webhook-BvaTV4Du.js";
import { C as CalendarClock } from "./calendar-clock-4IRMSl7u.js";
import { P as Play } from "./play-DKNhmyRj.js";
import { T as Timer } from "./timer-BM3RjL5K.js";
import "node:events";
...
const capabilities = [
  ...
  },
  {
    ...
    description: "Drag-and-drop workflow editor built on React Flow. Connect nodes, set conditions, and deploy in minutes. See your entire automation as a clear, visual diagram."
  },
  {
    icon: Timer,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base leading-relaxed", children: "Stale entity detection catches leads that haven't progressed, customers that went quiet, and tasks that are overdue. Automatically." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-24 lg:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1200px] px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        className: "text-center mb-16",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tag-neo text-signature mb-6 inline-block", children: "Professional-Grade" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Reliable automation that never drops the ball. Your workflows keep running through outages, retry automatically when something fails, and never lose track of where they left off." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
