...
import { U as Users, B as Brain, S as Share2, M as Mail, F as FileText, L as LandingLayout } from "./LandingLayout-DOJhVwxc.js";
...
const painPoints = [
  {
    ...
    description: "A single blog post takes 4-6 hours. A full content calendar takes weeks of planning. By the time you publish, the topic is old news and your competitors already own the SERP."
  },
  {
    icon: Users,
    title: "Writers are expensive and inconsistent",
    description: "Freelancers miss deadlines. In-house writers cost $60K+/year. And neither can cover every topic your clients need. Quality swings wildly from piece to piece."
  },
  {
    icon: TrendingDown,
    title: "Content gets published and forgotten",
    description: "You spend hours creating a piece, hit publish, share it once on social, and move on. No optimization, no repurposing, no distribution strategy. Most content dies the day it goes live."
  },
  {
    icon: Layers,
    title: "No system connects creation to results",
    description: "Your content calendar lives in one tool, SEO data in another, social scheduling in a third. Nobody knows which content drives leads, and proving ROI to clients is a guessing game."
  }
];
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "text-center max-w-3xl mx-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "tag-neo rounded-full text-signature mb-6 inline-flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(PenTool, { className: "w-3.5 h-3.5" }),
              "Content Marketing"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-display font-display text-foreground mb-6", children: [
              ...
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-signature", children: "the headcount" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto", children: "Research, create, optimize, distribute, and measure -- all powered by AI. OzziOS turns your content operation into a production engine that never misses a deadline." }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "mt-16 max-w-2xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-neo rounded-xl p-6 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-4xl md:text-5xl text-signature mb-2", children: "4.2hrs" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Average time to produce a single blog post manually. OzziOS does it in under 15 minutes." })
          ] }) })
        ]
      }
    ) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl lg:text-5xl text-foreground tracking-tight mb-4", children: "Content is a treadmill" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Every agency knows content is king. But producing enough quality content consistently is a battle most lose." })
        ]
      }
    ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl lg:text-5xl text-foreground tracking-tight mb-4", children: "From idea to impact, end-to-end" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-2xl mx-auto", children: "OzziOS manages the entire content lifecycle. Each stage feeds into the next, creating a flywheel that gets smarter with every piece you publish." })
        ]
      }
    ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-3 card-neo rounded-full px-6 py-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "Measurement feeds back into research. Your content strategy improves with every cycle." })
        ] })
      }
    )
  ] }) });
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl lg:text-5xl text-foreground tracking-tight mb-4", children: "Your content team, automated" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Six capabilities that replace a full content team -- from research to reporting." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl lg:text-5xl text-foreground tracking-tight mb-4", children: "More content, better results" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Agencies using OzziOS for content marketing produce more, rank higher, and prove ROI to clients." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground tracking-tight mb-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-signature", children: "Start scaling content." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground mb-10 max-w-lg mx-auto", children: "Launch your AI content engine in minutes. Research, create, optimize, and distribute -- all on autopilot." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: "https://app.ozzios.com/sign-up",
...
function ContentMarketingPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LandingLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContentMarketingView, {}) });
}
export {
  ContentMarketingPage as component
};
