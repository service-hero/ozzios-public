...
import { a_ as FilePenLine, Z as Zap, O as PenTool, E as Eye, c as Clock, w as TriangleAlert, U as Users, L as Lock, a$ as History, b0 as Bell, a7 as Webhook, C as CircleCheck, A as ArrowRight, S as Shield } from "./vendor-icons-BkkOHNOi.js";
...
const painPoints = [
  ...
  },
  {
    ...
    description: "When a customer disputes what they agreed to, you need timestamped proof of every view, sign, and decline. Most tools give you nothing."
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    description: "Sensitive customer agreements sent via email with no verification. No OTP, no identity checks, no encrypted storage."
  }
];
const capabilities = [
  {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl text-foreground tracking-tight mb-4", children: "Professional-grade signing for every deal" }),
...
function DocumentsView() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DeferredSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ComplianceSection, {}) }),
