...
import { A as AnimatePresence, g as Palette, B as Brain, L as LandingLayout } from "./LandingLayout-CWwQi4iJ.js";
...
import { F as FileDown } from "./file-down-AZRyty3m.js";
import { I as Image } from "./image-gOXxwnVi.js";
...
import { L as LayoutGrid } from "./layout-grid-CB4unM_o.js";
import "node:events";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full px-4 sm:px-8 text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.p,
      {
        ...
        children: "Service Hero -- Annual Review 2025"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full px-4 sm:px-8 text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.blockquote,
      {
        ...
        children: '"This platform cut our presentation time from 6 hours to 15 minutes. Our customers notice the quality difference."'
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] sm:text-[10px] text-muted-foreground", children: "VP of Marketing, Service Hero" })
        ]
      }
    )
  ] });
...
const painPoints = [
  {
    ...
    description: "Your team spends 4-6 hours building each customer presentation. That is time not spent on strategy, campaigns, or revenue-generating work."
  },
  {
    icon: TriangleAlert,
    title: "Inconsistent brand quality",
    description: "Every team member has a different PowerPoint style. Customers see different fonts, layouts, and quality levels depending on who builds the deck."
  },
  {
    icon: Palette,
...
const capabilities = [
  ...
  },
  {
    icon: FileDown,
    title: "PPTX Export",
    description: "Export any presentation to PowerPoint format via Remotion rendering. Share with customers who live in their own tools."
  },
  {
    icon: Image,
    title: "8 Slide Types",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Businesses spend 15-20% of billable hours on presentation work that customers glance at for five minutes." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Everything you need to create compelling customer presentations at scale." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function WorkflowSection() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Use the built-in viewer with transitions or export to PPTX. Share directly with customers from the platform."
    }
  ];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-24 lg:py-32 bg-muted/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-4xl px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground mb-10 max-w-lg mx-auto", children: "Stop spending hours on slide design. Let AI handle the heavy lifting while your team focuses on strategy and customer relationships." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
