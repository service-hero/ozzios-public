...
const $$splitComponentImporter$9 = () => import("./waitlist-business-CyDhWgUm.js");
const Route$9 = createFileRoute("/waitlist-business")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./waitlist-D6_FnG1e.js");
const Route$8 = createFileRoute("/waitlist")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./tos-CAc-xGjQ.js");
const Route$7 = createFileRoute("/tos")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./privacy-policy-B6wsZ-Mb.js");
const Route$6 = createFileRoute("/privacy-policy")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./integrations-KIbFlI4I.js");
const Route$5 = createFileRoute("/integrations")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./blog-Bde07CZ_.js");
const Route$4 = createFileRoute("/blog")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./index-DK7b40eZ.js");
const Route$3 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./blog.index-COTtQRO9.js");
const Route$2 = createFileRoute("/blog/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./_-UihyxPz8.js");
const Route$1 = createFileRoute("/docs/$")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./blog._postId-B85WU6ZY.js");
const Route2 = createFileRoute("/blog/$postId")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const WaitlistBusinessRoute = Route$9.update({
  id: "/waitlist-business",
  path: "/waitlist-business",
  getParentRoute: () => Route$a
});
const WaitlistRoute = Route$8.update({
  id: "/waitlist",
  path: "/waitlist",
  getParentRoute: () => Route$a
});
const TosRoute = Route$7.update({
  id: "/tos",
  path: "/tos",
  getParentRoute: () => Route$a
});
...
const IntegrationsRoute = Route$5.update({
  id: "/integrations",
  path: "/integrations",
  getParentRoute: () => Route$a
});
