...
import { u as useAudience, b as audienceContent, S as Share2, M as Mail, F as FileText, g as Palette } from "./LandingLayout-CWo80zJB.js";
import { u as useInView } from "./use-in-view-BpgOvvSs.js";
import { m as motion } from "./proxy-D0v6-HR_.js";
...
import { W as Wrench } from "./wrench-2WnZfvde.js";
...
const showcaseAgents = [
  ...
  { name: "Ozzi", role: "General Purpose", icon: WandSparkles, description: "Versatile AI agent for any marketing task — copy, research, strategy, reporting, and more", mp4: "/images/avatars/generic-ozzi-1.mp4" },
  { name: "Ozzi", role: "General Purpose", icon: WandSparkles, description: "Versatile AI agent for any marketing task — copy, research, strategy, reporting, and more", mp4: "/images/avatars/generic-ozzi-2.mp4" },
  { name: "Ozzi", role: "General Purpose", icon: WandSparkles, description: "Versatile AI agent for any marketing task — copy, research, strategy, reporting, and more", mp4: "/images/avatars/generic-ozzi-3.mp4" }
];
        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row min-h-[320px]", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-8 lg:p-12 flex flex-col justify-center", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground leading-relaxed mb-8 font-light max-w-lg", children: "Ozzi is your AI marketing supervisor. He coordinates every agent on your team — assigning tasks, reviewing outputs, catching errors, and making sure the work gets done. While your specialists handle execution, Ozzi handles oversight so you never have to." }),
