import { x as getDefaultExportFromCjs, n as jsxRuntimeExports, a as reactExports } from "./worker-entry-Mj0z-o-D.js";
import { L as Link, a as Route } from "./router-cm0nIOFR.js";
import { m as motion, A as ArrowRight } from "./proxy-DPQSpClc.js";
import { A as ArrowLeft } from "./arrow-left-XJ2wc80Z.js";
import { c as createLucideIcon } from "./createLucideIcon-DTvF4Gta.js";
import { C as Clock } from "./clock-C3T_uyqr.js";
import { C as Check } from "./check-CmasRM07.js";
import { C as ChevronRight } from "./chevron-right-bY9qHB9I.js";
import "node:events";
...
function BlogPostView({ postId }) {
  ...
  if (!post2) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background pt-32 pb-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[800px] px-6 lg:px-8 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/50 mb-8", children: "The article you're looking for doesn't exist." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/blog", className: "text-amber-400 hover:text-amber-300", children: "← Back to blog" })
    ] }) });
  }
  const copyLink = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative pt-32 pb-12 lg:pt-40 lg:pb-16 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto max-w-[800px] px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: "hidden",
          animate: "visible",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                to: "/blog",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "flex flex-wrap items-center gap-3 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-3 py-1.5 rounded-full bg-indigo-500/20 text-[11px] font-semibold text-indigo-400 uppercase tracking-wider", children: post2.categoryLabel }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-[13px] text-foreground/40", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "flex items-center gap-4 mb-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] font-medium text-foreground", children: post2.author.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-foreground/40", children: post2.author.role })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "flex items-center gap-3 mb-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] text-foreground/40", children: "Share:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: copyLink,
                  className: "w-9 h-9 rounded-lg bg-white/[0.05] border border-white/[0.08] flex items-center justify-center text-foreground/50 hover:text-foreground hover:bg-white/[0.1] transition-all",
                  children: copied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-emerald-400" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Link2, { className: "w-4 h-4" })
                }
              )
            ] })
          ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.section,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-[1000px] px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-2xl overflow-hidden border border-white/[0.08]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: post2.image,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 border-t border-white/[0.06]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-[900px] px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-foreground/40 uppercase tracking-wider mb-2", children: "Written by" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-foreground mb-1", children: post2.author.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] text-amber-400/70 mb-3", children: post2.author.role }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] text-foreground/50 leading-relaxed mb-4", children: post2.author.bio }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 border-t border-white/[0.06]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-[1000px] px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        whileInView: { opacity: 1, y: 0 },
            ...
            Link,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3 text-[11px] text-foreground/40", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-3 h-3" }),
                    relatedPost.readTime
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[15px] font-semibold text-foreground group-hover:text-amber-200 transition-colors line-clamp-2", children: relatedPost.title })
                ] })
              ]
            },
            relatedPost.id
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 border-t border-white/[0.06]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-[600px] px-6 lg:px-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] text-foreground/40 mb-8", children: "Start with 50 free credits. No credit card required." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
