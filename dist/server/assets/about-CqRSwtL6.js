...
import { B as Brain, U as Users, L as LandingLayout } from "./LandingLayout-CWwQi4iJ.js";
import { CTASection } from "./CTASection-BdSNYTnU.js";
...
const values = [
  ...
  },
  {
    ...
    description: "No black boxes. Every action your AI team takes is logged, visible, and auditable. You see exactly what your business operations are doing, 24/7."
  },
  {
    icon: Brain,
    title: "Service-First Design",
    description: "Built by people who ran home service companies. We know the pain of missed calls, scheduling chaos, and customer churn. OzziOS is the platform we wished we had."
  },
  {
    icon: Users,
      ...
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl md:text-5xl lg:text-6xl text-foreground tracking-tight mb-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-signature", children: "for home service companies" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-12", children: "We're building a future where every home service company has access to a full operations team -- powered by AI agents that work 24/7, never quit, and get smarter every day." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl lg:text-5xl text-foreground tracking-tight mb-6", children: "Born from the frustration of running a home service business" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-muted-foreground text-base leading-relaxed", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "We spent years working with home service companies -- HVAC, plumbing, roofing, electrical, landscaping. We know what it's like to hire, train, and lose dispatchers and office staff. We know the pain of missed calls, scheduling nightmares, and losing customers because no one followed up." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "So we asked a simple question: what if AI could handle the repetitive, process-driven work that buries your office team -- and do it better, faster, and 24/7?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "OzziOS is the answer. We built an unlimited AI workforce — 30+ specialized agents out of the box, plus the ability to create your own. They work together, share knowledge, and never leave you scrambling for coverage. Because they never leave." })
          ] })
        ]
      }
    ),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-neo rounded-xl p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Home service companies drown in admin work. Missed calls, scheduling errors, and dropped follow-ups cost thousands in lost revenue every month." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "80% of office work in a service company is repeatable process. AI can handle it -- with total transparency and zero turnover." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "An unlimited AI workforce that works 24/7, remembers everything, and shows you every action they take. Your operations, fully visible." })
            ] })
          ] })
        ] }) })
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "A small, focused team building the future of home service operations." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-3 card-neo rounded-full px-6 py-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "We're hiring. Join us and build the future of home services." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: "/careers",
