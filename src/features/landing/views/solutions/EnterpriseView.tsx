...
const painPoints = [
  {
    ...
    description:
      'Every location has different needs, different schedules, different customer expectations. Your team cannot keep it all straight without things falling through the cracks.',
  },
  {
    icon: Layers,
    title: 'Tool sprawl is costing you',
    description:
      'You are paying for 10-15 different tools. Your data lives in silos. Your team wastes hours switching between platforms and reconciling reports.',
  },
  {
    icon: Globe,
      ...
      <div className="mx-auto max-w-[1200px] px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">
            What worked at 10 locations does not work at 50. The processes that got you here will not get you there.
          </p>
        </motion.div>
