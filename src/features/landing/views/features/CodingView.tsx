...
const capabilities = [
  ...
  },
  {
    ...
    description:
      'Start from battle-tested templates for search performance, ad performance, social engagement, traffic analytics, and executive KPI reports.',
  },
  {
    icon: Save,
  ...
  const steps = [
    {
      ...
      description:
        'Tell your AI agent what you need -- a search performance report, an ad performance dashboard, a KPI summary. It writes a complete React application with real data visualizations.',
    },
    {
      step: '02',
