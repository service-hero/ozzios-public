...
const pricingTiers: PricingTier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Social planner & email builder', description: 'Stay consistent on social with AI-assisted planning. Send professional emails with the visual builder.' },
      { label: 'All integrations & forms', description: 'Connect 40+ tools — Google, Meta, Shopify, WordPress. Build smart lead forms with workflow triggers.' },
