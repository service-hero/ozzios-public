...
export const enterpriseLogos = [
  ...
  { name: 'Jobber', width: 'w-24', logo: '/images/logos/jobber-logo.webp' },
  ...
  { name: 'HubSpot', width: 'w-24', logo: '/images/logos/hubspot-logo.webp' },
  ...
  { name: 'Thumbtack', width: 'w-24', logo: '/images/logos/thumbtack-logo.webp' },
  { name: 'Yelp', width: 'w-20', logo: '/images/logos/yelp-logo.webp' },
  { name: 'Angi', width: 'w-20', logo: '/images/logos/angieslist-logo.webp' },
  ...
  { name: 'Klaviyo', width: 'w-20', logo: '/images/logos/klaviyo-logo.webp' },
  { name: 'Mailchimp', width: 'w-24', logo: '/images/logos/mailchimp-logo.webp' },
