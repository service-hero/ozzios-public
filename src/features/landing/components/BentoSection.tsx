      ...
      <div className="relative z-10 mx-auto max-w-[1100px] px-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {/* Card 3: Slack-class Communication */}
            <motion.div variants={itemVariants}>
              <BentoCard>
                ...
                <div className="flex items-center gap-2 text-[12px] text-white/40 mt-auto">
                  <span className="flex items-center gap-1">
                    <div className="h-1.5 w-1.5 rounded-full bg-emerald-400" />
                    Real-time
                  </span>
                  <span>•</span>
                  <span>&lt;200ms delivery</span>
                </div>
              </BentoCard>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              <BentoCard>
                ...
                <p className="text-[32px] font-semibold text-white">31</p>
              ...
              <BentoCard>
                ...
                <div className="flex items-center gap-3 mt-auto">
                  {['Meta', 'Google', 'LinkedIn', 'TikTok'].map((platform) => (
                    <span key={platform} className="text-[11px] text-white/40">
                      {platform}
                    </span>
                  ))}
                </div>
