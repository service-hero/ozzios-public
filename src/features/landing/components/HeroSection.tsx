          ...
          >
            <div className="relative">
              ...
              <div className="relative rounded-2xl border border-border bg-background overflow-hidden shadow-2xl shadow-black/10">
                ...
                <div className="flex items-center gap-2 px-4 py-3 border-b border-border bg-muted/50">
                  ...
                  <div className="flex-1 flex justify-center">
                    <div className="flex items-center gap-2 px-4 py-1.5 rounded-lg bg-background border border-border">
                      ...
                      <span className="text-[11px] text-muted-foreground font-mono">app.ozzios.com</span>
                    </div>
                  </div>
                  <div className="w-16" />
                </div>
                ...
                <div className="relative aspect-[3/4] sm:aspect-[4/3] md:aspect-[16/9] bg-muted/50 flex overflow-hidden">
                  {/* Sidebar */}
                  <div className="hidden md:flex w-56 flex-col border-r border-border bg-background">
                    {/* Workspace header */}
                  ...
                  <div className="flex-1 flex flex-col min-w-0 min-h-0 overflow-hidden">
                    {/* Channel header */}
                    <div className="relative flex items-center justify-between px-3 sm:px-4 py-2 border-b border-border bg-background">
                      <button
                      ...
                      >
                        ...
                        <ChevronDown className={`w-3 h-3 text-muted-foreground transition-transform ${mobileMenuOpen ? 'rotate-180' : ''}`} />
                      </button>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <Settings className="w-4 h-4 text-muted-foreground hidden sm:block" />
                      </div>
                    ...
                    {/* Messages */}
                    <div ref={messagesContainerRef} className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden p-3 sm:p-4 space-y-4 scrollbar-hidden bg-background">
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0 overflow-hidden">
                                <div className="flex flex-wrap items-center gap-1 sm:gap-2 mb-1">
                                  ...
                                  <span className="text-[9px] sm:text-[10px] text-muted-foreground shrink-0">{message.time}</span>
                                </div>

                                <div className="text-[11px] sm:text-[12px] text-muted-foreground leading-relaxed break-words overflow-hidden">
                                  {(() => {
                                        ...
                                        <div key={i} className="my-2 space-y-1.5">
                                          {(part.items as Array<{icon: string; action: string; status: string; detail: string}>).map((item, j) => (
                                            ...
                                            >
                                              ...
                                              <span className="text-foreground font-medium text-[11px]">{item.action}</span>
                                              <span className="hidden sm:inline text-muted-foreground text-[10px]">•</span>
                                              <span className="hidden sm:inline text-muted-foreground text-[10px] truncate max-w-[150px]">{item.detail}</span>
                                      ...
                                      return (
                                        <div key={i} className="my-2 space-y-1.5">
                                          {(part.items as Array<{keyword: string; volume: string; difficulty: string; intent: string}>).map((item, j) => (
                                            ...
                                            >
                                              <span className="flex-1 text-foreground text-[11px] font-medium truncate">{item.keyword}</span>
                                              <div className="flex items-center gap-2 shrink-0">
                                                <span className="text-[10px] text-muted-foreground">{item.volume}/mo</span>
                                    ...
                                    if (part.type === 'code' && 'content' in part) {
                                      ...
                                      return (
                                        <div key={i} className="my-2 p-2 sm:p-3 rounded-lg bg-gray-900 border border-border font-mono text-[9px] sm:text-[10px] text-green-400 whitespace-pre-wrap break-all overflow-hidden">
                                          {part.content}
                                        </div>
                                      );
                                    }
                                    if (part.type === 'preview' && 'url' in part) {
                                      ...
                                      return (
                                        <div key={i} className="my-3">
                                          ...
                                          >
                                            {/* Mini Dashboard UI */}
                                            <div className="relative p-3 bg-gradient-to-br from-muted/50 to-muted">
                                              {/* Dashboard Header */}
                                              ...
                                              <div className="rounded bg-background border border-border overflow-hidden">
                                                ...
                                                {[
                                                  ...
                                                  <div key={row.channel} className="grid grid-cols-3 gap-2 px-2 py-1 border-b border-border/50 last:border-0">
                                                    ...
                                                    <span className="text-[7px] text-foreground text-right font-medium">{row.revenue}</span>
                                              ...
                                              {/* e2b badge */}
                                              <div className="absolute bottom-2 right-2 flex items-center gap-1 px-1.5 py-0.5 rounded bg-background/80 backdrop-blur-sm border border-border">
                                            ...
                                            <div className="p-2.5 border-t border-border bg-background">
                                              <div className="flex items-center justify-between gap-2">
                                                <div className="min-w-0">
                                                  <div className="flex items-center gap-1.5">
                                                    <h4 className="text-[11px] font-semibold text-foreground truncate group-hover:text-signature transition-colors">
                                                      {previewData.title}
                                                    </h4>
                                                    <ArrowRight className="w-3 h-3 text-muted-foreground group-hover:text-signature group-hover:translate-x-0.5 transition-all" />
                                                  </div>
                      ...
                      <div className="flex items-center gap-1.5 mb-2 overflow-x-auto scrollbar-hidden">
                        ...
                        {(activeChannel === 'seo-campaigns' ? [
                          ...
                          >
                            ...
                            <span className="text-[10px] text-muted-foreground group-hover:text-foreground whitespace-nowrap">{chip.label}</span>
                          </button>
                        ))}
                      </div>
