...
export function HeroSection() {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[rgb(23,23,23)]"
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-0">
        <div
          className="absolute top-1/4 left-1/2 -translate-x-1/2 h-[500px] w-[700px] rounded-full blur-[150px]"
          style={{
      ...
      {/* Content container */}
      <div className="relative z-10 mx-auto max-w-[1000px] px-6 py-32 lg:py-40">
        <motion.div
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-8">
            <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-[13px] font-medium text-white/60 backdrop-blur-sm">
              <span className="relative flex h-2 w-2">
                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-orange-400 opacity-75" />
                <span className="relative inline-flex h-2 w-2 rounded-full bg-orange-500" />
              </span>
              Introducing the future of agency automation
            </span>
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-[44px] sm:text-[56px] lg:text-[72px] font-semibold tracking-tight text-white leading-[1.05] max-w-4xl mx-auto"
          >
            The{' '}
          ...
          <motion.p
            variants={itemVariants}
            className="mt-8 text-[18px] sm:text-[20px] text-white/50 leading-relaxed max-w-2xl mx-auto font-light"
          >
            14 specialized AI agents. Unified CRM, workflows, and communication.
            One platform to run your entire agency—without the overhead.
          </motion.p>
          ...
          >
            ...
            <Button
              variant="outline"
              size="lg"
              className="h-14 px-8 text-[15px] font-medium gap-2 rounded-full border-white/20 bg-white/5 text-white hover:bg-white/10 hover:text-white"
            >
          ...
          >
            <p className="text-[14px] text-white/40 font-medium mb-6">
              ...
              >
                ...
                {[...Array(2)].map((_, setIndex) => (
                  <div key={setIndex} className="flex items-center gap-12 shrink-0">
                    {['Acme Corp', 'Globex', 'Initech', 'Umbrella', 'Stark', 'Wayne'].map((name, i) => (
                      <div
                        key={`${setIndex}-${i}`}
